...
function Test-MacOsWorkflow {
    ...
    $requiredWorkflowMarkers = @(
        ...
        "native_tab_color_swatch_count=70",
        ...
        "native_fill_color_swatch_count=70",
        "native_font_color_swatch_count=70",
    ...
    $sourceContracts = @(
        ...
        @{
            ...
            Markers = @(
                ...
                "ShellFocusCyclePlanner.GetNextAvailable(current, reverse, IsShellFocusTargetAvailable)",
                ...
                "ConfirmBeforeDestructiveWorkbookActionAsync(`"Close Workbook`", `"Discard and Close`")",
                "ResetToNewWorkbook(`"Closed workbook.`");",
                "private async void MainWindow_Closing(object? sender, WindowClosingEventArgs e)",
                "ConfirmBeforeDestructiveWorkbookActionAsync(`"Close FreeX`", `"Discard and Close`")",
                "private async Task TryQuitApplicationAsync()",
                "ConfirmBeforeDestructiveWorkbookActionAsync(`"Quit FreeX`", `"Discard and Quit`")",
