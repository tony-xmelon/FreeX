...
static ParityReport BuildReport(string root)
{
    ...
    var areas = new[]
    {
        ...
        new Area("slideshow.media-playback-backend", "Slideshow/media", "host-adapter-deferred", "WPF has MediaElement playback; Avalonia retains poster rendering and click consumption but needs a native/third-party media backend for audio/video frames and sound."),
    };
    ...
    var residuals = new[]
    {
        ...
        new Residual("avalonia-media-backend", "host-adapter-deferred", "Avalonia audio/video playback and transition-sound playback require a host media backend outside the current dependency set.", "Poster rendering, source classification, hit testing, and non-advance click behavior are closed."),
