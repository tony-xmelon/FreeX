...
Assert-DashboardCondition ((@($dashboard.pendingIntegrationGates) -join ",") -eq "repository-preflight") "Wave194 pending integration gates must retain only repository preflight."
