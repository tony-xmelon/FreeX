...
$acceptanceRefreshTestedSourceCommit = "3d60b7b421b388ccfa5c9c18dc4e25642b7a14c6"
...
Assert-DashboardCondition ([string]$dashboard.integrationGateEvidence.reintegration -eq "Merge commit 3d60b7b421b388ccfa5c9c18dc4e25642b7a14c6 contained current origin/main's six foreground-capture commits merged with the already accepted Wave194 histories; the merge contained zero overlapping paths between those inputs.") "Wave194 reintegration evidence must record the six foreground-capture commits and zero overlapping paths."
Assert-DashboardCondition ([string]$dashboard.integrationGateEvidence.focusedTests -eq "At tested source commit 3d60b7b421b388ccfa5c9c18dc4e25642b7a14c6: FreeX Avalonia Wave194 9/9; FreeX Presentation Wave194 1/1; FreeX Core.IO Wave194 plus five foreground-capture guards 8/8; FreeP Presentation Wave194 2/2.") "Wave194 focused-test evidence must record each requested lane."
Assert-DashboardCondition ([string]$dashboard.integrationGateEvidence.initialReintegrationPreflight -eq "Initial repository preflight reached the generated/dashboard guards and failed only because the prior tested-source anchor treated these three incoming paths as outside the acceptance allowlist: docs/testing/freex-excel-ux-parity-suite.md, tests/FreeX.Core.IO.Tests/ToolHarnessDedupSourceTests.cs, tools/FreeX.ForegroundCapture/Program.cs. Remediated by anchoring tested source at 3d60b7b421b388ccfa5c9c18dc4e25642b7a14c6, not by expanding the allowlist.") "Wave194 initial reintegration preflight evidence must record the anchor-only remediation."
