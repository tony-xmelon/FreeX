...
$temporary = Join-Path $parent ".freex-wave197-number-format-$PID-$([guid]::NewGuid().ToString('N').Substring(0, 8)).tmp"
...
$workbook = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><workbook xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships"><sheets><sheet name="Ribbon Number Format" sheetId="1" r:id="rId1"/></sheets><calcPr calcId="197029" calcMode="auto" fullCalcOnLoad="1" forceFullCalc="1"/></workbook>'
...
$worksheet = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"><dimension ref="A1:B2"/><sheetViews><sheetView workbookViewId="0" showGridLines="1"/></sheetViews><sheetData><row r="1"><c r="A1" t="n"><v>1234.5</v></c><c r="B1" t="inlineStr"><is><t>Wave197 Number Target</t></is></c></row><row r="2"><c r="A2" t="inlineStr"><is><t>Select A1, then Alt H N, Down, Enter</t></is></c></row></sheetData></worksheet>'
