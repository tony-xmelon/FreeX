...
function New-Cell {
    ...
    $style = if ($StyleId -eq 0) { "" } else { ' s="' + $StyleId + '"' }
    '<c r="' + $Address + '"' + $style + ' t="inlineStr"><is><t>' + $escaped + '</t></is></c>'
}
...
$temporary = Join-Path $parent ".freex-wave195-color-$PID-$([guid]::NewGuid().ToString('N').Substring(0, 8)).tmp"
...
$workbook = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><workbook xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships"><sheets><sheet name="AutoFilter Color Change" sheetId="1" r:id="rId1"/></sheets><calcPr calcId="195039" calcMode="auto" fullCalcOnLoad="1" forceFullCalc="1"/></workbook>'
...
$styles = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><styleSheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"><fonts count="1"><font><sz val="11"/><name val="Calibri"/></font></fonts><fills count="4"><fill><patternFill patternType="none"/></fill><fill><patternFill patternType="gray125"/></fill><fill><patternFill patternType="solid"><fgColor rgb="FF00B050"/><bgColor indexed="64"/></patternFill></fill><fill><patternFill patternType="solid"><fgColor rgb="FFFFC000"/><bgColor indexed="64"/></patternFill></fill></fills><borders count="1"><border><left/><right/><top/><bottom/><diagonal/></border></borders><cellStyleXfs count="1"><xf numFmtId="0" fontId="0" fillId="0" borderId="0" xfId="0"/></cellStyleXfs><cellXfs count="4"><xf numFmtId="0" fontId="0" fillId="0" borderId="0" xfId="0"/><xf numFmtId="0" fontId="0" fillId="2" borderId="0" xfId="0"/><xf numFmtId="0" fontId="0" fillId="3" borderId="0" xfId="0"/><xf numFmtId="0" fontId="0" fillId="0" borderId="0" xfId="0"/></cellXfs><cellStyles count="1"><cellStyle name="Normal" xfId="0" builtinId="0"/></cellStyles></styleSheet>'
...
for ($row = 0; $row -lt $rows.Count; $row++) {
    ...
    [void]$rowXml.Append((New-Cell -Address "A$number" -Value $rows[$row][0] -StyleId $rows[$row][1]))
    [void]$rowXml.Append((New-Cell -Address "B$number" -Value "Value"))
