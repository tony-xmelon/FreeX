...
File.WriteAllText(args[1], JsonSerializer.Serialize(inventory, options) + Environment.NewLine, utf8);
File.WriteAllText(args[2], FreeWCommandInventoryMarkdown.Build(inventory), utf8);
