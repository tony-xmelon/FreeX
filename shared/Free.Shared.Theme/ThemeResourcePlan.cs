    ...
    public static ThemeResourcePlan Create(Theme theme, string keyPrefix)
    {
        ...
        return new ThemeResourcePlan(
            ...
            [
                ...
                Color("BackstageSidebar", colors.BackstageSidebar),
                Color("BackstageHover", colors.BackstageHover),
                Color("BackstageSelected", colors.BackstageSelected),
                Color("BackstageSeparator", colors.BackstageSeparator),
                Color("BackstageLink", colors.BackstageLink),
