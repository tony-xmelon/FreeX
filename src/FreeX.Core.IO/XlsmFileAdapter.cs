...
/// package preservation layer in <see cref="XlsxFileAdapter"/> carries the part through automatically
/// on round-trip — this adapter does not need to handle it specially.
/// </summary>
