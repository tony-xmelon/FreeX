...
internal static partial class XlsxPivotTableReader
{
        ...
        out PendingPivotTableModel pivotTable)
    {
        ...
        pivotTable = new PendingPivotTableModel(
            ...
            ReadPivotFieldIndexes(root.Element(workbookNs + "rowFields"), workbookNs, pivotCache, nativeFieldSelections, nativeFieldGroups, nativeFieldMetadata),
            ReadPivotFieldIndexes(root.Element(workbookNs + "colFields"), workbookNs, pivotCache, nativeFieldSelections, nativeFieldGroups, nativeFieldMetadata),
