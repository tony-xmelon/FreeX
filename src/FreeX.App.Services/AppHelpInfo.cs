...
public static class AppHelpInfo
{
    ...
    public const string TrademarkNotice = FamilyLegalNotices.FreeXTrademarkNotice;
    ...
    public const string CompatibilityNotice = "Compatibility references are descriptive only. File-format labels use neutral names such as XLSX Workbook. Compatibility varies by feature; see the documented support matrix before relying on a specific feature.";
