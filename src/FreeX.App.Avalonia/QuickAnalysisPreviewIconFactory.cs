...
internal static class QuickAnalysisPreviewIconFactory
{
    ...
    private static void AddGrid(Canvas canvas, IBrush fill, IBrush stroke)
    {
    ...
    private static void AddRect(Canvas canvas, double left, double top, double width, double height, IBrush fill)
    {
        var rect = new Rectangle
        {
            Width = width,
    ...
    private static void AddEllipse(Canvas canvas, double left, double top, IBrush fill, double size = 5)
    {
    ...
    private static void AddLine(Canvas canvas, double x1, double y1, double x2, double y2, IBrush stroke, double thickness)
    {
