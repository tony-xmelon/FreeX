...
/// drawing objects, charts, text boxes, comments, hyperlinks, header/footer pictures, and text
/// wrapping/trimming — only the cell grid, gridlines, headings, and header/footer text are produced.
/// </summary>
