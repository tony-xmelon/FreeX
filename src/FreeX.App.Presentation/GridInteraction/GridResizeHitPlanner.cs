...
/// <summary>
/// Pure hit-testing for row/column resize handles in the grid headers, including collapsed-boundary
/// detection so a hidden run of rows/columns can be reopened by dragging the merged edge. Shared by
/// the desktop hosts so both resolve the same resize target for a given pointer position.
/// </summary>
