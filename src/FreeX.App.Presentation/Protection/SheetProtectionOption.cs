...
/// checked state. The list of these (see <see cref="SheetProtectionOptions.All"/>) mirrors
...
/// </param>
public sealed record SheetProtectionOption(SheetProtectionPermission Permission, bool DefaultEnabled);
