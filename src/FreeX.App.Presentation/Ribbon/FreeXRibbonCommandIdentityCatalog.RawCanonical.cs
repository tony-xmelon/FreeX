...
/// <see cref="FreeXRibbonCommandIdentityCatalog"/> handler ids. These are mostly split-button / dropdown menu items
...
{
    public static readonly IReadOnlySet<string> RawCanonicalAvaloniaIds =
