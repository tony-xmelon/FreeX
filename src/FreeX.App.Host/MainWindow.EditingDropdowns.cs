...
public partial class MainWindow
{
    ...
    private void EnsureValidationDropdown()
    {
        ...
        _validationDropdown = new System.Windows.Controls.ComboBox
        {
            ...
            ToolTip = UiText.Get("DataValidation_DropdownToolTip")
        };
        AutomationProperties.SetAutomationId(_validationDropdown, "WorksheetDataValidationDropdown");
        AutomationProperties.SetName(_validationDropdown, UiText.Get("DataValidation_DropdownAutomationName"));
        AutomationProperties.SetHelpText(_validationDropdown, UiText.Get("DataValidation_DropdownHelpText"));
    ...
    private void EnsureDvInputMessageBorder()
    {
        ...
        AutomationProperties.SetName(_dvInputMessageBorder, UiText.Get("DataValidation_InputMessageAutomationName"));
