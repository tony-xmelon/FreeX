    ...
    public static RibbonDefinition Build() => new RibbonDefinitionBuilder()
        ...
        .Tab("PageLayoutTab", "Page Layout", "P", tab => tab
            ...
            .Group("PageLayoutPageSetupGroup", "Page Setup", null, priority: 200,
                g => g
                .Sizing(RibbonGroupSizing.Default with { MaximumRowsPerColumn = 2 })
                .DialogLauncher("Page Setup", "Page Setup", "Open the Page Setup dialog.")
                .Medium("Margins", "Margins", Ico.Margins, "M", menu: m => m.Item(FreeXRibbonCommandIds.PageLayoutMarginsNormal, "Normal", "N").Item(FreeXRibbonCommandIds.PageLayoutMarginsWide, "Wide", "W").Item(FreeXRibbonCommandIds.PageLayoutMarginsNarrow, "Narrow", "A").Item(FreeXRibbonCommandIds.PageLayoutMarginsCustom, "Custom Margins...", "C"))
                .Medium("Page Orientation", "Orientation", Ico.Orientation, "OR", menu: m => m.Item(FreeXRibbonCommandIds.PageLayoutOrientationPortrait, "Portrait", "P").Item(FreeXRibbonCommandIds.PageLayoutOrientationLandscape, "Landscape", "L"))
                .Medium("Paper Size", "Size", Ico.Page, "SZ", menu: m => m.Item(FreeXRibbonCommandIds.PageLayoutPaperSizeLetter, "Letter", "L").Item(FreeXRibbonCommandIds.PageLayoutPaperSizeLegal, "Legal", "G").Item(FreeXRibbonCommandIds.PageLayoutPaperSizeExecutive, "Executive", "E").Item(FreeXRibbonCommandIds.PageLayoutPaperSizeStatement, "Statement", "S").Item(FreeXRibbonCommandIds.PageLayoutPaperSizeTabloid, "Tabloid", "T").Item(FreeXRibbonCommandIds.PageLayoutPaperSizeA4, "A4", "A").Item(FreeXRibbonCommandIds.PageLayoutPaperSizeA3, "A3", "3").Item(FreeXRibbonCommandIds.PageLayoutPaperSizeA5, "A5", "5").Item(FreeXRibbonCommandIds.PageLayoutPaperSizeB4Jis, "B4 (JIS)", "B4").Item(FreeXRibbonCommandIds.PageLayoutPaperSizeB5Jis, "B5 (JIS)", "B5"))
                .Medium("Print Area", "Print Area", Ico.Print, "PA", menu: m => m.Item(FreeXRibbonCommandIds.PageLayoutPrintAreaSet, "Set Print Area", "S").Item(FreeXRibbonCommandIds.PageLayoutPrintAreaClear, "Clear Print Area", "C"))
                .Medium("Breaks", "Breaks", Ico.PageBreak, "BK", menu: m => m.Item(FreeXRibbonCommandIds.PageLayoutBreakInsert, "Insert Page Break", "I").Item(FreeXRibbonCommandIds.PageLayoutBreakRemove, "Remove Page Break", "R").Item(FreeXRibbonCommandIds.PageLayoutBreakResetAll, "Reset All Page Breaks", "A"))
                .Medium("Background", "Background", Ico.Picture, "BG", menu: m => m.Item(FreeXRibbonCommandIds.PageLayoutBackgroundChoose, "Choose Background...", "C").Item(FreeXRibbonCommandIds.PageLayoutBackgroundDelete, "Delete Background", "D"))
                .Medium("Print Titles", "Print Titles", Ico.Print, "PT"))
        ...
        .Tab("ReviewTab", "Review", "R", tab => tab
            .Group("ReviewProofingGroup", "Proofing", null, priority: 200,
                ...
                .Large(FreeXRibbonCommandIds.ReviewTranslate, "Translate", Ico.Translate, "TR")
                .Large(FreeXRibbonCommandIds.ReviewCheckPerformance, "Check Performance", Ico.Warning, "CP")
