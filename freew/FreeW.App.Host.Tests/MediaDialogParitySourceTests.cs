...
public sealed class MediaDialogParitySourceTests
{
    ...
    [InlineData("InsertSmartArtDialog.cs", "SmartArtDialogPlanner.ResolveText(UiText.Get)")]
    ...
    [InlineData("MediaDialogParity.cs", "SmartArtDialogPlanner.ResolveText(UiText.Get)")]
