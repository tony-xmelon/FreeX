...
{
    [Fact]
    public void WpfOptionsDialogLeavesPortableLifetimeAndCommitDecisionsWithSession()
    {
        var source = ReadHostSource("OptionsDialog.cs");
    ...
    [Fact]
    public void WpfPropertiesDialogLeavesCatalogProjectionAndCommitDecisionsWithSession()
    {
        var source = ReadHostSource("PropertiesDialog.cs");
