...
public static class DocxWriter
{
    ...
    public static void Write(TextDocument document, Stream stream)
    {
        ...
        WritePart(archive, "[Content_Types].xml", BuildContentTypes(hasAnyPng, hasLists, headerFooterParts, hasFootnotes, hasEndnotes, hasComments, hasWatermark, hasSettings, charts, embeddedObjects.Count > 0, smartArts, hasEmbeddedFonts, document.Preserved.Parts));
