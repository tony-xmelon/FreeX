...
public static class FreeWDialogEvidenceCatalog
{
    ...
    private static IReadOnlyList<FreeWDialogEvidenceRoute> BuildRoutes()
    {
        var routes = new List<FreeWDialogEvidenceRoute>
        {
            ...
            AvaloniaOnly("draw-table-dimension", "DrawTableDimensionDialog"),
            AvaloniaOnly("field-picker", "FieldPickerDialog"),
            ...
            AvaloniaOnly("manage-sources", "ManageSourcesDialog"),
            ...
            AvaloniaOnly("table-text-conversion", "TableTextConversionDialog"),
