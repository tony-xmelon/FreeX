    ...
    for (int i = 0; i < pageCount; i++)
    {
        ...
        // WPF visual with correct layout. The watermark and background are drawn as fills behind it.
        {
            ...
            using (var dc = composite.RenderOpen())
            {
                ...
                // Layer 1b: Word's single fixed-size VML watermark shape over the page background.
                // BuildWatermarkBrush relies on an attached page surface, so reproduce the planned
                // shape directly for this headless renderer.
...
/// <summary>
/// Renders Word's single fixed-size VML watermark shape as a bitmap. The live editor receives page
/// dimensions from its attached page surface; the fidelity renderer supplies those dimensions here.
/// </summary>
