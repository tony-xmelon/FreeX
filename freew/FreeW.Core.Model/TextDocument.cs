...
public sealed class TextDocument
{
    ...
    /// <summary>
    /// Whether grammar-error indicators should be hidden for this document. Maps to
    /// <c>w:settings/w:hideGrammaticalErrors</c>. False is Word's default and is omitted from newly authored
    /// packages; true suppresses grammar-error visual cues without changing the document's proofing data.
    /// </summary>
