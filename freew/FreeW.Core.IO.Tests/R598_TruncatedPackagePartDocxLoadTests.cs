...
public class R598_TruncatedPackagePartDocxLoadTests
{
    /// <summary>
    ...
    /// </summary>
    [Fact]
    public void TruncatingAnyPartRefusesWithFreeWsOwnError()
    {
        ...
        leaked.Should().BeEmpty(
            "a truncated package must surface FreeW's own InvalidDataException, not a raw framework " +
