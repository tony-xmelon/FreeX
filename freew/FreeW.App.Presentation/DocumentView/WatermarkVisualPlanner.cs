...
{
    // FreeW emits text watermarks as Word's conventional VML text-path shape. Its 468 x 117pt
    // extent, not a generic page-width label, determines Word's visible text scale and position.
