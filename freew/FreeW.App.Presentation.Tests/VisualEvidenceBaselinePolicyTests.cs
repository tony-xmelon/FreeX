...
public sealed class VisualEvidenceBaselinePolicyTests
{
    ...
    [Fact]
    public void WordBaselinePolicy_KeepsSectionGeometryProofsDirectlyComparable()
    {
        foreach (var scenarioId in FreeWVisualEvidenceManifestNormalizer.SectionGeometryVisualProofScenarioIds)
        {
            var row = BuildRow(
                scenarioId,
                FreeWVisualEvidenceManifestNormalizer.AvaloniaHostId,
    ...
    [Fact]
    public void WordBaselinePolicy_KeepsReviewCompareCombineProofsDirectlyComparable()
    {
        foreach (var scenarioId in FreeWVisualEvidenceManifestNormalizer.ReviewCompareCombineVisualProofScenarioIds)
        {
            var row = BuildRow(
                scenarioId,
                FreeWVisualEvidenceManifestNormalizer.WpfHostId,
    ...
    [Fact]
    public void WordBaselinePolicy_KeepsReviewProofingProofsDirectlyComparable()
    {
        foreach (var scenarioId in FreeWVisualEvidenceManifestNormalizer.ReviewProofingVisualProofScenarioIds)
        {
            var row = BuildRow(
                scenarioId,
                FreeWVisualEvidenceManifestNormalizer.AvaloniaHostId,
