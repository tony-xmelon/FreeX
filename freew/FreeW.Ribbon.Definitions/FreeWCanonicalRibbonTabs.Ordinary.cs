...
internal static partial class FreeWCanonicalRibbonTabs
{
    ...
    internal static RibbonDefinitionBuilder AddHomeTab(
        ...
        capabilities.UseAvaloniaBackedSurface
            ? AddAvaloniaHomeTab(builder)
            : AddWpfHomeTab(builder);

    internal static RibbonDefinitionBuilder AddInsertTab(
        this RibbonDefinitionBuilder builder,
        FreeWRibbonCapabilities capabilities) =>
        capabilities.UseAvaloniaBackedSurface
            ? AddAvaloniaInsertTab(builder)
            : AddWpfInsertTab(builder);

    internal static RibbonDefinitionBuilder AddReferencesTab(
        this RibbonDefinitionBuilder builder,
        FreeWRibbonCapabilities capabilities) =>
        capabilities.UseAvaloniaBackedSurface
            ? AddAvaloniaReferencesTab(builder)
            : AddWpfReferencesTab(builder);

    internal static RibbonDefinitionBuilder AddReviewTab(
        this RibbonDefinitionBuilder builder,
        FreeWRibbonCapabilities capabilities) =>
        capabilities.UseAvaloniaBackedSurface
            ? AddAvaloniaReviewTab(builder)
            : AddWpfReviewTab(builder);

    private static RibbonDefinitionBuilder AddWpfHomeTab(RibbonDefinitionBuilder builder)
    {
    ...
    private static RibbonDefinitionBuilder AddAvaloniaHomeTab(RibbonDefinitionBuilder builder)
    {
        return builder
    ...
    private static RibbonDefinitionBuilder AddWpfInsertTab(RibbonDefinitionBuilder builder)
    {
        var symbolsGroup = FreeWRibbonText.SymbolsGroup;
        var symbolCommand = FreeWRibbonText.SymbolCommand;
        return builder
    ...
    private static RibbonDefinitionBuilder AddAvaloniaInsertTab(RibbonDefinitionBuilder builder)
    {
        return builder
    ...
    private static RibbonDefinitionBuilder AddWpfReferencesTab(RibbonDefinitionBuilder builder)
    {
        return builder
    ...
    private static RibbonDefinitionBuilder AddAvaloniaReferencesTab(RibbonDefinitionBuilder builder)
    {
        return builder
    ...
    private static RibbonDefinitionBuilder AddWpfReviewTab(RibbonDefinitionBuilder builder)
    {
        return builder
    ...
    private static RibbonDefinitionBuilder AddAvaloniaReviewTab(RibbonDefinitionBuilder builder)
    {
        return builder
            .Tab("review", "Review", "R", tab =>
            {
