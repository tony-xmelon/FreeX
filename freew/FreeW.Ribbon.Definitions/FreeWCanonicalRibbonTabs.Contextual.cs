...
/// Profile-specific builders preserve each renderer's established structural representation.
/// </summary>
internal static partial class FreeWCanonicalRibbonTabs
{
    ...
    internal static RibbonDefinitionBuilder AddPictureContextualTab(
        ...
        capabilities.UseAvaloniaBackedSurface
            ? AddAvaloniaPictureContextualTab(builder, capabilities)
            : AddWpfPictureContextualTab(builder, capabilities);

    internal static RibbonDefinitionBuilder AddDrawingContextualTab(
        this RibbonDefinitionBuilder builder,
        FreeWRibbonCapabilities capabilities) =>
        capabilities.UseAvaloniaBackedSurface
            ? AddAvaloniaDrawingContextualTab(builder, capabilities)
            : AddWpfDrawingContextualTab(builder, capabilities);

    internal static RibbonDefinitionBuilder AddChartContextualTabs(
        this RibbonDefinitionBuilder builder,
        FreeWRibbonCapabilities capabilities) =>
        capabilities.UseAvaloniaBackedSurface
            ? AddAvaloniaChartContextualTabs(builder, capabilities)
            : AddWpfChartContextualTabs(builder, capabilities);

    internal static RibbonDefinitionBuilder AddSmartArtContextualTab(
        this RibbonDefinitionBuilder builder,
        FreeWRibbonCapabilities capabilities) =>
        capabilities.UseAvaloniaBackedSurface
            ? AddAvaloniaSmartArtContextualTab(builder, capabilities)
            : AddWpfSmartArtContextualTab(builder, capabilities);

    internal static RibbonDefinitionBuilder AddTableContextualTabs(
        this RibbonDefinitionBuilder builder,
        FreeWRibbonCapabilities capabilities) =>
        capabilities.UseAvaloniaBackedSurface
            ? AddAvaloniaTableContextualTabs(builder, capabilities)
            : AddWpfTableContextualTabs(builder, capabilities);

    private static RibbonDefinitionBuilder AddWpfPictureContextualTab(
        RibbonDefinitionBuilder builder,
        FreeWRibbonCapabilities capabilities) =>
        ...
        {
            tab.Group("picture-arrange", "Arrange", "A", 100, group =>
            {
            ...
            tab.Group("picture-styles", "Picture Styles", "Y", 98, group =>
            {
            ...
            tab.Group("picture-adjust", "Adjust", "J", 95, group =>
            {
            ...
            tab.Group("picture-size", "Size", "S", 90, group =>
            {
    ...
    private static RibbonDefinitionBuilder AddAvaloniaPictureContextualTab(
        RibbonDefinitionBuilder builder,
        FreeWRibbonCapabilities capabilities) =>
        builder.ContextualTab("picture-format", "Picture Format",
            new RibbonTabContext(capabilities.PictureContextKey, "Picture Tools", RibbonContextColor.Orange), tab =>
        {
            tab.Group("picture-arrange", "Arrange", null, 100, group =>
            {
            ...
            tab.Group("picture-styles", "Picture Styles", null, 98, group =>
            {
                foreach (var preset in PictureStyleCatalog.Catalog)
                {
            ...
            tab.Group("picture-adjust", "Adjust", null, 90, group =>
            {
            ...
            tab.Group("picture-size", "Size", null, 90, group =>
            {
    ...
    private static RibbonDefinitionBuilder AddWpfDrawingContextualTab(
        RibbonDefinitionBuilder builder,
        FreeWRibbonCapabilities capabilities) =>
        ...
        {
            tab.Group("drawing-insert", "Insert Shapes", "I", 110, group =>
            {
            ...
            tab.Group("drawing-styles", "Shape Styles", "H", 100, group =>
            {
            ...
            tab.Group("drawing-text", "Text", "X", 90, group =>
            {
            ...
            tab.Group("drawing-wordart", "WordArt Styles", "W", 85, group =>
            {
            ...
            tab.Group("drawing-arrange", "Arrange", "A", 80, group =>
            {
            ...
            tab.Group("drawing-size", "Size", "S", 70, group =>
            {
    ...
    private static RibbonDefinitionBuilder AddAvaloniaDrawingContextualTab(
        RibbonDefinitionBuilder builder,
        FreeWRibbonCapabilities capabilities) =>
        builder.ContextualTab("drawing-format", "Drawing Format",
            new RibbonTabContext(capabilities.DrawingContextKey, "Drawing Tools", RibbonContextColor.Purple), tab =>
        {
            tab.Group("drawing-styles", "Shape Styles", null, 100, group =>
            {
            ...
            tab.Group("drawing-arrange", "Arrange", null, 90, group =>
            {
            ...
            tab.Group("drawing-size", "Size", null, 80, group =>
            {
    ...
    private static RibbonDefinitionBuilder AddWpfChartContextualTabs(
        RibbonDefinitionBuilder builder,
        FreeWRibbonCapabilities capabilities) =>
        builder
            ...
            {
                tab.Group("chart-type", "Type", "T", 100, group =>
                ...
                tab.Group("chart-data", "Data", "D", 90, group =>
                    group.Medium("freew.chart-edit-data", "Edit Data", RibbonCommandIconKind.Table));
                tab.Group("chart-quick-layout", "Quick Layout", "L", 85, group =>
                {
                ...
                tab.Group("chart-elements", "Chart Layouts", "E", 70, group =>
                {
            ...
            .ContextualTab("chart-format", "Chart Format",
                new RibbonTabContext(capabilities.ChartContextKey, "Chart Tools", RibbonContextColor.Orange), tab =>
            {
                tab.Group("chart-arrange", "Arrange", "A", 100, group =>
                {
                    group.Medium("freew.shape-rotate", "Rotate", RibbonCommandIconKind.Rotate, menu: menu =>
                    {
                        menu.Item("freew.shape-rotate-right90", "Rotate Right 90\u00B0", "R");
                ...
                tab.Group("chart-size", "Size", "S", 90, group =>
                {
    ...
    private static RibbonDefinitionBuilder AddAvaloniaChartContextualTabs(
        RibbonDefinitionBuilder builder,
        FreeWRibbonCapabilities capabilities) =>
        builder
            .ContextualTab("chart-design", "Chart Design",
                new RibbonTabContext(capabilities.ChartContextKey, "Chart Tools", RibbonContextColor.Green), tab =>
            {
                tab.Group("chart-type", "Type", null, 100, group =>
                    group.Dropdown("freew.chart-type", "Change Chart Type", BuildChartTypeMenu()));
                tab.Group("chart-data", "Data", null, 80, group =>
                {
                ...
                tab.Group("chart-quick-layout", "Quick Layout", null, 85, group =>
                {
                    foreach (var layout in ChartQuickLayout.Catalog)
                    {
                ...
                tab.Group("chart-styles", "Chart Styles", null, 90, group =>
                {
                ...
                tab.Group("chart-elements", "Chart Elements", null, 80, group =>
                {
            ...
            .ContextualTab("chart-format", "Chart Format",
                new RibbonTabContext(capabilities.ChartContextKey, "Chart Tools", RibbonContextColor.Green), tab =>
            {
                tab.Group("chart-arrange", "Arrange", null, 100, group =>
                {
                    group.Dropdown("freew.shape-rotate", "Rotate", BuildRotateMenu("shape"));
                    group.Dropdown("freew.shape-wrap", "Wrap Text", BuildWrapMenu("shape"));
                    group.Button("freew.image-bring-to-front", "Bring to Front");
                ...
                tab.Group("chart-size", "Size", null, 90, group =>
                {
    ...
    private static RibbonDefinitionBuilder AddWpfSmartArtContextualTab(
        RibbonDefinitionBuilder builder,
        FreeWRibbonCapabilities capabilities) =>
        ...
        {
            tab.Group("smartart-create-graphic", "Create Graphic", "G", 100, group =>
            {
            ...
            tab.Group("smartart-arrange", "Arrange", "A", 60, group =>
            {
                group.Medium("freew.shape-rotate", "Rotate", RibbonCommandIconKind.Rotate, menu: menu =>
                {
                    menu.Item("freew.shape-rotate-right90", "Rotate Right 90\u00B0", "R");
    ...
    private static RibbonDefinitionBuilder AddAvaloniaSmartArtContextualTab(
        RibbonDefinitionBuilder builder,
        FreeWRibbonCapabilities capabilities) =>
        builder.ContextualTab("smartart-design", "SmartArt Design",
            new RibbonTabContext(capabilities.SmartArtContextKey, "SmartArt Tools", RibbonContextColor.Blue), tab =>
        {
            tab.Group("smartart-create-graphic", "Create Graphic", null, 120, group =>
            {
            ...
            tab.Group("smartart-edit", "Edit", null, 90, group =>
                group.Button("freew.smartart-edit-text", "Edit Text"));
            tab.Group("smartart-layouts", "Layouts", null, 100, group =>
                group.Dropdown("freew.smartart-layout", "Layouts", BuildSmartArtLayoutMenu()));
            tab.Group("smartart-styles", "SmartArt Styles", null, 90, group =>
            {
            ...
            tab.Group("smartart-arrange", "Arrange", null, 80, group =>
            {
                group.Dropdown("freew.shape-rotate", "Rotate", BuildRotateMenu("shape"));
                group.Dropdown("freew.shape-wrap", "Wrap Text", BuildWrapMenu("shape"));
                group.Button("freew.image-bring-to-front", "Bring to Front");
            ...
            tab.Group("smartart-size", "Size", null, 70, group =>
            {
                group.ComboBox("freew.shape-width", "Width", control => control with
                {
                    Items = FloatSizes,
    ...
    private static RibbonDefinitionBuilder AddWpfTableContextualTabs(
        RibbonDefinitionBuilder builder,
        FreeWRibbonCapabilities capabilities) =>
        builder
            ...
            {
                tab.Group("table-style-options", "Table Style Options", "O", 100, group =>
                {
                ...
                tab.Group("table-style", "Table Style", "Y", 80, group =>
                {
                ...
                tab.Group("draw-borders", "Draw Borders", "D", 60, group =>
                {
            ...
            .ContextualTab("table-layout", "Table Layout",
                new RibbonTabContext(capabilities.TableContextKey, "Table Tools", RibbonContextColor.Teal), tab =>
            {
                tab.Group("table-table", "Table", "T", 70, group =>
                {
                ...
                tab.Group("table-rows-cols", "Rows & Columns", "R", 120, group =>
                {
                ...
                tab.Group("table-merge", "Merge", "M", 90, group =>
                {
                ...
                tab.Group("table-cell-size", "Cell Size", "Z", 100, group =>
                {
                ...
                tab.Group("table-alignment", "Alignment", "A", 110, group =>
                {
                ...
                tab.Group("table-data", "Data", "D", 70, group =>
                {
    ...
    private static RibbonDefinitionBuilder AddAvaloniaTableContextualTabs(
        RibbonDefinitionBuilder builder,
        FreeWRibbonCapabilities capabilities) =>
        builder
            .ContextualTab("table-design", "Table Design",
                new RibbonTabContext(capabilities.TableContextKey, "Table Tools", RibbonContextColor.Teal), tab =>
            {
                tab.Group("table-style-options", "Table Style Options", null, 100, group =>
                {
                ...
                tab.Group("table-style", "Table Style", null, 90, group =>
                {
                ...
                tab.Group("draw-borders", "Draw Borders", null, 80, group =>
                {
            ...
            .ContextualTab("table-layout", "Table Layout",
                new RibbonTabContext(capabilities.TableContextKey, "Table Tools", RibbonContextColor.Teal), tab =>
            {
                tab.Group("table-select", "Table", null, 110, group =>
                {
                ...
                tab.Group("table-rows-cols", "Rows & Columns", null, 100, group =>
                {
                ...
                tab.Group("table-merge", "Merge", null, 90, group =>
                {
                ...
                tab.Group("table-cell-size", "Cell Size", null, 95, group =>
                {
                ...
                tab.Group("table-alignment", "Alignment", null, 110, group =>
                {
                ...
                tab.Group("table-data", "Data", null, 80, group =>
                {
