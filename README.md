...
Tester builds are published on the [FreeX releases page](https://github.com/tony-xmelon/FreeX/releases). The current tester release is **v0.8.189** (2026-09-09), published for all three apps on Windows, Linux, and macOS.

FreeX v0.8.189 downloads (each asset has a matching `.sha256`):

- [FreeX-v0.8.189-win-x64.exe](https://github.com/tony-xmelon/FreeX/releases/download/freex-v0.8.189/FreeX-v0.8.189-win-x64.exe)
- [FreeX-v0.8.189-linux-x64.zip](https://github.com/tony-xmelon/FreeX/releases/download/freex-v0.8.189/FreeX-v0.8.189-linux-x64.zip) / [linux-arm64](https://github.com/tony-xmelon/FreeX/releases/download/freex-v0.8.189/FreeX-v0.8.189-linux-arm64.zip)
- [FreeX-v0.8.189-osx-arm64.zip](https://github.com/tony-xmelon/FreeX/releases/download/freex-v0.8.189/FreeX-v0.8.189-osx-arm64.zip) / [osx-x64](https://github.com/tony-xmelon/FreeX/releases/download/freex-v0.8.189/FreeX-v0.8.189-osx-x64.zip)
...
```bash
xattr -dr com.apple.quarantine /Applications/FreeX.app
```

Per-app release tags, all non-prerelease:

- [FreeX v0.8.189](https://github.com/tony-xmelon/FreeX/releases/tag/freex-v0.8.189)
- [FreeW v0.8.189](https://github.com/tony-xmelon/FreeX/releases/tag/freew-v0.8.189)
- [FreeP v0.8.189](https://github.com/tony-xmelon/FreeX/releases/tag/freep-v0.8.189)
- [Free Suite v0.8.189](https://github.com/tony-xmelon/FreeX/releases/tag/free-suite-v0.8.189) - all three apps in one installer per platform
