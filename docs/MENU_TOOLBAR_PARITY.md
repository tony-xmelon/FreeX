...
| Gradients/Effects | Partial | Shape gradient fill with direction presets, dedicated access-keyed start/end color pickers, and selectable None/Shadow/Inner Shadow/Reflection/Glow/Soft Edges effects with rendering plus native JSON/XLSX persistence; full Excel gradient/effect galleries pending |
