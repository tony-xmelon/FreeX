...
Generated: 2026-08-08 13:21 +03:00
Repository: https://github.com/tony-xmelon/FreeX.git
Baseline ref: HEAD at `e219728e1` (`e219728e1c055247f00ff05ecccf2c74e9deb6a1`)
...
- Local branches: 4
- Remote branches: 537
- Tracked files: 13,895
- Current C# source LOC: 1,234,473
- Current C# test LOC: 1,185,402
- Current XAML LOC: 6,862
- Current docs LOC: 137,582
...
- Provider log bytes attributed (all machines reporting so far): 200,820,388,595
- Observed raw provider tokens (all machines reporting so far): 4,181,456,386,069
- Provider-style billable-equivalent tokens (all machines reporting so far): 2,138,897,369,969
...
| 2026-06-16 | 107 | 334 | +18,140 / -12,667 | +10,949 / -6,481 | +1,878 / -2,265 | +2,414 / -19 | +64,179,004 / -0 | 1,129,966 | 75,483,343 | 2 |
| 2026-06-17 | 556 | 709 | +107,409 / -5,766 | +66,962 / -3,569 | +34,555 / -1,483 | +3,169 / -466 | +49,582,997 / -0 | 55,874,027 | 699,069,320 | 2 |
| 2026-06-18 | 205 | 1163 | +32,866 / -8,917 | +20,486 / -4,674 | +6,557 / -1,220 | +1,718 / -189 | +130,439,175 / -0 | 51,822,119 | 837,838,817 | 3 |
...
| 2026-08-08 | 20 | 167 | +24,734 / -9,468 | +2,859 / -198 | +6,644 / -388 | +12,268 / -8,853 | +188,976,627 / -0 | 0 | 302,659,741 | 4 |
| TOTAL | 31,933 | 88,886 | +6,221,292 / -2,643,720 | +1,846,004 / -596,989 | +1,597,642 / -390,886 | +214,520 / -76,007 | +200,820,388,595 / -0 | 4,164,885,194,664 | 16,571,191,405 | 6 |
...
| Docs/Tooling/Other | 7,911 | 43,108 | +1,276,268 / -835,464 |
| TOTAL | 23,579 | 88,886 | +6,221,292 / -2,643,720 |
...
| 2026-08 | Docs/Tooling/Other | 1,079 | 992 | +64,942 / -19,023 |
...
| Avalonia (Linux/macOS) | 3,283 | 3,409 | +414,542 / -64,953 |
| Platform-neutral (core/shared/IO/model) | 9,328 | 20,086 | +2,757,734 / -524,417 |
| Non-code | 7,911 | 43,108 | +1,276,268 / -835,464 |
| TOTAL | 28,323 | 88,886 | +6,221,292 / -2,643,720 |
...
| 2026-08 | Avalonia (Linux/macOS) | 654 | 625 | +55,632 / -6,910 |
| 2026-08 | Non-code | 1,079 | 992 | +64,942 / -19,023 |
...
| 2026-08-08 | anthropic | 33 | 33 | 1,364 | 188,976,627 | 54,614 | 0 | 6,460,856 | 295,600,601 | 543,670 | 0 | 302,659,741 | 38,234,414 |
...
| 2026-06-16 | anthropic | 12 | 12 | 520 | 36,217,842 | 110,507 | 0 | 3,220,254 | 71,884,761 | 267,821 | 0 | 75,483,343 | 11,592,122 |
...
| 2026-06-18 | anthropic | 43 | 43 | 3,332 | 96,215,623 | 484,287 | 0 | 20,894,622 | 814,159,666 | 2,300,242 | 0 | 837,838,817 | 110,318,773 |
| 2026-06-18 | openai | 6 | 6 | 426 | 34,223,552 | 51,486,863 | 49,053,952 | 0 | 0 | 269,324 | 65,932 | 51,822,119 | 27,295,143 |
| TOTAL | all | 10836 | 10836 | 29,066,067 | 200,820,388,595 | 4,155,046,729,955 | 4,056,290,863,744 | 402,546,910 | 16,126,912,173 | 7,825,483,582 | 2,054,713,449 | 4,181,456,386,069 | 2,138,897,369,969 |
...
| --- | ---: | ---: |
| Anthropic (Claude) | 16,571,191,405 | 2,157,607,177 |
| OpenAI (Codex) | 4,164,885,194,664 | 2,136,739,762,792 |
| TOTAL | 4,181,456,386,069 | 2,138,897,369,969 |
...
| anthropic | Docs/Tooling/Other | 4,173 | 1,025,787,948 | 135,870,257 |
| openai | FreeX | 298,755 | 42,143,528,287 | 21,713,117,855 |
| openai | FreeW | 3 | 298,675 | 156,595 |
| openai | FreeP | 109 | 12,986,905 | 6,829,017 |
| openai | Docs/Tooling/Other | 1,143,658 | 150,221,594,330 | 77,286,632,922 |
...
| anthropic | Non-code | 4,173 | 1,025,787,948 | 135,870,257 |
| openai | Windows (WPF) | 199,271 | 28,159,713,323 | 14,515,661,611 |
| openai | Avalonia (Linux/macOS) | 367 | 45,691,985 | 23,921,681 |
| openai | Platform-neutral (core/shared/IO/model) | 99,159 | 13,939,815,038 | 7,174,500,158 |
| openai | Non-code | 1,143,728 | 150,233,187,851 | 77,292,652,939 |
...
| --- | ---: | ---: |
| FreeX | 1,349,794,383,055 | 32.3 % |
| FreeW | 731,729,407,545 | 17.5 % |
| FreeP | 1,081,543,119,893 | 25.9 % |
| Shared | 49,373,531,329 | 1.2 % |
| Docs/Tooling/Other | 969,015,944,248 | 23.2 % |
| Unallocated (tokens logged, no churn that day) | 0 | 0.0 % |
| TOTAL | 4,181,456,386,069 | 100.0% |
...
| --- | ---: | ---: |
| Windows (WPF) | 655,603,147,473 | 15.7 % |
| Avalonia (Linux/macOS) | 834,907,936,821 | 20.0 % |
| Platform-neutral (core/shared/IO/model) | 1,721,929,357,528 | 41.2 % |
| Non-code | 969,015,944,248 | 23.2 % |
| Unallocated (tokens logged, no churn that day) | 0 | 0.0 % |
| TOTAL | 4,181,456,386,069 | 100.0% |
...
- The daily churn table covers 2026-05-12 through 2026-08-08, computed fresh from git history reachable from HEAD (`e219728e1`) at generation time.
- Across the window: 31,933 commits, 88,886 changed-file/day entries, +6,221,292 / -2,643,720 LoC.
- Token rows reflect 200,820,388,595 bytes of local provider logs, 4,181,456,386,069 observed raw tokens, and 2,138,897,369,969 provider-style billable-equivalent tokens, from machine(s): ALITOP, DESKTOP-DGEV3SF, I5-32GB.
