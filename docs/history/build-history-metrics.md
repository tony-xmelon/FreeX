...
Generated: 2026-08-08 14:30 +03:00
Repository: https://github.com/tony-xmelon/FreeX.git
Baseline ref: HEAD at `c5dc994f6` (`c5dc994f658a5cbe039968e456802881582e0c7a`)
...
- Provider log bytes attributed (all machines reporting so far): 180,009,081,288
- Observed raw provider tokens (all machines reporting so far): 4,031,030,752,289
- Provider-style billable-equivalent tokens (all machines reporting so far): 2,061,697,288,004
...
| 2026-06-16 | 107 | 334 | +18,140 / -12,667 | +10,949 / -6,481 | +1,878 / -2,265 | +2,414 / -19 | +64,757,096 / -0 | 1,129,966 | 75,483,343 | 2 |
...
| 2026-08-08 | 21 | 168 | +27,450 / -9,629 | +2,859 / -198 | +6,644 / -388 | +12,488 / -9,011 | +189,554,719 / -0 | 0 | 341,087,406 | 4 |
| TOTAL | 31,934 | 88,887 | +6,224,008 / -2,643,881 | +1,846,004 / -596,989 | +1,597,642 / -390,886 | +214,740 / -76,165 | +180,009,081,288 / -0 | 4,014,421,133,219 | 16,609,619,070 | 6 |
...
| Docs/Tooling/Other | 7,912 | 43,109 | +1,278,984 / -835,625 |
| TOTAL | 23,580 | 88,887 | +6,224,008 / -2,643,881 |
...
| 2026-08 | Docs/Tooling/Other | 1,080 | 993 | +67,658 / -19,184 |
...
| Non-code | 7,912 | 43,109 | +1,278,984 / -835,625 |
| TOTAL | 28,324 | 88,887 | +6,224,008 / -2,643,881 |
...
| 2026-08 | Non-code | 1,080 | 993 | +67,658 / -19,184 |
...
| 2026-08-08 | anthropic | 33 | 33 | 1,429 | 189,554,719 | 54,744 | 0 | 6,541,019 | 333,892,798 | 598,845 | 0 | 341,087,406 | 42,219,143 |
...
| 2026-06-16 | anthropic | 12 | 12 | 520 | 36,795,934 | 110,507 | 0 | 3,220,254 | 71,884,761 | 267,821 | 0 | 75,483,343 | 11,592,122 |
...
| TOTAL | all | 7033 | 7033 | 27,928,401 | 180,009,081,288 | 4,004,928,712,819 | 3,909,770,874,240 | 402,627,073 | 16,165,204,370 | 7,528,162,361 | 2,006,045,666 | 4,031,030,752,289 | 2,061,697,288,004 |
...
| --- | ---: | ---: |
| Anthropic (Claude) | 16,609,619,070 | 2,161,591,905 |
| OpenAI (Codex) | 4,014,421,133,219 | 2,059,535,696,099 |
| TOTAL | 4,031,030,752,289 | 2,061,697,288,004 |
...
| anthropic | Docs/Tooling/Other | 3,575 | 1,008,667,674 | 129,991,500 |
| anthropic | Unclassified (no file-edit yet) | 663 | 55,547,939 | 9,863,486 |
| openai | FreeX | 173,897 | 24,509,364,657 | 12,688,386,993 |
| openai | FreeW | 3 | 298,675 | 156,595 |
| openai | FreeP | 109 | 12,986,905 | 6,829,017 |
| openai | Docs/Tooling/Other | 110,550 | 15,724,543,937 | 8,199,358,017 |
| openai | Unclassified (no file-edit yet) | 20,235 | 1,667,152,578 | 907,939,074 |
...
| anthropic | Non-code | 3,575 | 1,008,667,674 | 129,991,500 |
| anthropic | Unclassified (no file-edit yet) | 663 | 55,547,939 | 9,863,486 |
| openai | Windows (WPF) | 107,555 | 15,200,521,766 | 7,891,614,950 |
| openai | Avalonia (Linux/macOS) | 367 | 45,691,985 | 23,921,681 |
| openai | Platform-neutral (core/shared/IO/model) | 66,080 | 9,275,306,679 | 4,779,261,239 |
| openai | Non-code | 110,557 | 15,725,673,744 | 8,199,932,752 |
| openai | Unclassified (no file-edit yet) | 20,235 | 1,667,152,578 | 907,939,074 |
...
| --- | ---: | ---: |
| FreeX | 1,207,583,445,803 | 30.0 % |
| FreeW | 731,729,429,230 | 18.2 % |
| FreeP | 1,081,543,438,870 | 26.8 % |
| Shared | 49,373,560,708 | 1.2 % |
| Docs/Tooling/Other | 960,800,877,679 | 23.8 % |
| Unallocated (tokens logged, no churn that day) | 0 | 0.0 % |
| TOTAL | 4,031,030,752,289 | 100.0% |
...
| --- | ---: | ---: |
| Windows (WPF) | 566,540,675,636 | 14.1 % |
| Avalonia (Linux/macOS) | 834,771,850,800 | 20.7 % |
| Platform-neutral (core/shared/IO/model) | 1,668,917,348,174 | 41.4 % |
| Non-code | 960,800,877,679 | 23.8 % |
| Unallocated (tokens logged, no churn that day) | 0 | 0.0 % |
| TOTAL | 4,031,030,752,289 | 100.0% |
...
- The daily churn table covers 2026-05-12 through 2026-08-08, computed fresh from git history reachable from HEAD (`c5dc994f6`) at generation time.
- Across the window: 31,934 commits, 88,887 changed-file/day entries, +6,224,008 / -2,643,881 LoC.
- Token rows reflect 180,009,081,288 bytes of local provider logs, 4,031,030,752,289 observed raw tokens, and 2,061,697,288,004 provider-style billable-equivalent tokens, from machine(s): ALITOP, DESKTOP-DGEV3SF, I5-32GB.
