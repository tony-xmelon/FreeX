...
Generated: 2026-08-08 21:31 +03:00
Repository: https://github.com/tony-xmelon/FreeX.git
Baseline ref: HEAD at `8024e97e6` (`8024e97e62520136179642959c5447139b801e7d`)
...
- Provider log bytes attributed (all machines reporting so far): 200,998,772,552
- Observed raw provider tokens (all machines reporting so far): 4,181,315,814,653
- Provider-style billable-equivalent tokens (all machines reporting so far): 2,138,870,422,362
...
| 2026-06-16 | 107 | 334 | +18,140 / -12,667 | +10,949 / -6,481 | +1,878 / -2,265 | +2,414 / -19 | +66,504,718 / -0 | 1,129,966 | 75,483,343 | 2 |
...
| 2026-08-08 | 25 | 187 | +36,222 / -11,247 | +2,944 / -226 | +7,699 / -443 | +12,789 / -9,317 | +209,164,522 / -0 | 0 | 883,683,074 | 4 |
| TOTAL | 31,920 | 88,870 | +6,226,934 / -2,645,399 | +1,842,118 / -596,925 | +1,597,284 / -390,940 | +214,824 / -76,471 | +200,998,772,552 / -0 | 4,164,879,155,357 | 16,436,659,296 | 6 |
...
| Docs/Tooling/Other | 7,914 | 43,104 | +1,286,332 / -837,158 |
| TOTAL | 23,567 | 88,870 | +6,226,934 / -2,645,399 |
...
| 2026-08 | Docs/Tooling/Other | 1,084 | 995 | +75,223 / -20,717 |
...
| Non-code | 7,914 | 43,104 | +1,286,332 / -837,158 |
| TOTAL | 28,305 | 88,870 | +6,226,934 / -2,645,399 |
...
| 2026-08 | Non-code | 1,084 | 995 | +75,223 / -20,717 |
...
| 2026-08-08 | anthropic | 52 | 52 | 3,414 | 209,164,522 | 58,688 | 0 | 15,007,297 | 867,507,153 | 1,109,936 | 0 | 883,683,074 | 106,678,461 |
...
| 2026-06-16 | anthropic | 12 | 12 | 520 | 38,543,556 | 110,507 | 0 | 3,220,254 | 71,884,761 | 267,821 | 0 | 75,483,343 | 11,592,122 |
...
| TOTAL | all | 10722 | 10722 | 29,062,868 | 200,998,772,552 | 4,155,040,567,779 | 4,056,285,510,272 | 395,012,527 | 16,001,544,763 | 7,823,981,444 | 2,054,708,140 | 4,181,315,814,653 | 2,138,870,422,362 |
...
| --- | ---: | ---: |
| Anthropic (Claude) | 16,436,659,296 | 2,134,022,141 |
| OpenAI (Codex) | 4,164,879,155,357 | 2,136,736,400,221 |
| TOTAL | 4,181,315,814,653 | 2,138,870,422,362 |
...
| anthropic | Docs/Tooling/Other | 44,907 | 10,464,305,168 | 1,324,019,160 |
| anthropic | Unclassified (no file-edit yet) | 10,713 | 577,172,783 | 125,281,190 |
| openai | FreeX | 8,905,144 | 1,279,942,222,056 | 657,102,520,808 |
...
| openai | Docs/Tooling/Other | 10,225,597 | 1,470,467,692,613 | 753,553,165,893 |
...
| anthropic | Non-code | 44,907 | 10,464,305,168 | 1,324,019,160 |
| anthropic | Unclassified (no file-edit yet) | 10,713 | 577,172,783 | 125,281,190 |
| openai | Windows (WPF) | 2,722,811 | 381,298,811,951 | 196,587,799,599 |
| openai | Avalonia (Linux/macOS) | 5,867,129 | 856,804,095,990 | 439,030,013,174 |
| openai | Platform-neutral (core/shared/IO/model) | 4,733,957 | 677,771,063,135 | 347,945,809,631 |
| openai | Non-code | 10,229,297 | 1,470,985,994,472 | 753,841,142,696 |
| openai | Unclassified (no file-edit yet) | 383,175 | 42,792,441,987 | 22,155,328,451 |
...
| --- | ---: | ---: |
| FreeX | 1,349,289,929,354 | 32.3 % |
| FreeW | 731,697,859,320 | 17.5 % |
| FreeP | 1,081,512,079,193 | 25.9 % |
| Shared | 49,369,604,470 | 1.2 % |
| Docs/Tooling/Other | 969,446,342,316 | 23.2 % |
| Unallocated (tokens logged, no churn that day) | 0 | 0.0 % |
| TOTAL | 4,181,315,814,653 | 100.0% |

- Days allocated (had both tokens and churn weight): 87. Days with tokens but no churn to allocate against (routed to Unallocated): 0.
...
| --- | ---: | ---: |
| Windows (WPF) | 655,504,187,099 | 15.7 % |
| Avalonia (Linux/macOS) | 834,865,585,481 | 20.0 % |
| Platform-neutral (core/shared/IO/model) | 1,721,499,699,757 | 41.2 % |
| Non-code | 969,446,342,316 | 23.2 % |
| Unallocated (tokens logged, no churn that day) | 0 | 0.0 % |
| TOTAL | 4,181,315,814,653 | 100.0% |
...
- The daily churn table covers 2026-05-12 through 2026-08-08, computed fresh from git history reachable from HEAD (`8024e97e6`) at generation time.
- Across the window: 31,920 commits, 88,870 changed-file/day entries, +6,226,934 / -2,645,399 LoC.
- Token rows reflect 200,998,772,552 bytes of local provider logs, 4,181,315,814,653 observed raw tokens, and 2,138,870,422,362 provider-style billable-equivalent tokens, from machine(s): ALITOP, DESKTOP-DGEV3SF, I5-32GB.
