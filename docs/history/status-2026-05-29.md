...
> Metric counts refreshed 2026-05-30 to match live `git ls-files` after the 2026-05-30 code-review hardening pass added `WorkbookOpenSizeGuard`, `ExternalUrlLauncher`, and `AtomicFileWriter` (3 src + 3 test files). See [reviews/comprehensive-code-review-2026-05-30.md](../reviews/comprehensive-code-review-2026-05-30.md).
...
| History metrics | [history/build-history-metrics.md](build-history-metrics.md) is refreshed through 2026-05-29 inclusive |
...
Product parity remaining is tracked in [planning/next-phases.md](../planning/next-phases.md), including Phase 7D: Deeper color-scale XLSX edge semantics as new gaps are found. Current planning, parity, and release-readiness sources: [parity/command-surface.md](../parity/command-surface.md), [parity/menu-toolbar.md](../parity/menu-toolbar.md), [parity/shortcuts.md](../parity/shortcuts.md), [parity/functions.md](../parity/functions.md), [formats/fidelity-contract.md](../formats/fidelity-contract.md), [formats/xlsx-corpus-report.md](../formats/xlsx-corpus-report.md), [release/test-distribution.md](../release/test-distribution.md), and [performance/baseline.md](../performance/baseline.md).
