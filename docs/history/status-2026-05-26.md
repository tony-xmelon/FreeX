...
| Release readiness | `user/guide.md` and `user/troubleshooting.md` are written; tester-release workflow is JSON-versioned and now builds unsigned local MSIX packages when Windows SDK tooling is available; signing, installer trust validation, accessibility pass, and release-note polish remain open. |
...
| Area | Current state |
| --- | --- |
| Release documentation | `docs/user/guide.md` and `docs/user/troubleshooting.md` are present and linked from the docs index. |
...
| Planning docs | [planning/outstanding-build.md](../planning/outstanding-build.md), [planning/next-phases.md](../planning/next-phases.md), [formats/xlsx-corpus-report.md](../formats/xlsx-corpus-report.md), and this report are the current status set. Older status reports are historical snapshots only. |

## Remaining Outstanding Work

See [planning/outstanding-build.md](../planning/outstanding-build.md) for the source-of-truth backlog. Key open items:
...
Product parity remaining is tracked in [planning/next-phases.md](../planning/next-phases.md). Current planning and parity sources: [parity/command-surface.md](../parity/command-surface.md), [parity/menu-toolbar.md](../parity/menu-toolbar.md), [parity/shortcuts.md](../parity/shortcuts.md), [formats/fidelity-contract.md](../formats/fidelity-contract.md), and [formats/xlsx-corpus-report.md](../formats/xlsx-corpus-report.md).
