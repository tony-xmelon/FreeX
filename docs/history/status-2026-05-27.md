...
| Release readiness | `user/guide.md` and `user/troubleshooting.md` are written; tester-release workflow is JSON-versioned and produces unsigned local MSIX packages when Windows SDK tooling is available; signing, installer trust validation, accessibility pass, and release-note polish remain open. |
...
| Docs refresh | `README.md`, `planning/outstanding-build.md`, and this report were refreshed to match the current snapshot. |
...
Product parity remaining is tracked in [planning/next-phases.md](../planning/next-phases.md), including Phase 7D: Deeper color-scale XLSX edge semantics as new gaps are found. Current planning and parity sources: [parity/command-surface.md](../parity/command-surface.md), [parity/menu-toolbar.md](../parity/menu-toolbar.md), [parity/shortcuts.md](../parity/shortcuts.md), [formats/fidelity-contract.md](../formats/fidelity-contract.md), and [formats/xlsx-corpus-report.md](../formats/xlsx-corpus-report.md).
