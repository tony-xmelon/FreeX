...
| History metrics | [history/build-history-metrics.md](build-history-metrics.md) is refreshed through 2026-06-03 inclusive |
...
1. **Formula catalog status corrected**
   - Current docs now use the 487/487 in-scope function catalog from `parity/functions.md` and `FormulaParityCatalogTests`.
