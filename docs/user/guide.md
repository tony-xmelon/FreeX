...
| Category | Examples |
|---|---|
| Math & Trig | SUM, SUBTOTAL, AGGREGATE, SUMIF, SUMIFS, SUMPRODUCT, MMULT, MDETERM, MINVERSE, TRANSPOSE |
| Statistical | AVERAGE, COUNT, CORREL, PEARSON, COVARIANCE.P, RSQ, SLOPE, FORECAST.LINEAR, KURT, SKEW, TRIMMEAN |
...
| Financial | NPV, IRR, PMT, FV, PV, RATE, XNPV, XIRR, PRICE, YIELD, DURATION, ACCRINT |
