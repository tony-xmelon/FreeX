...
| Category | Examples |
|---|---|
| Math & Trig | SUM, SUBTOTAL, AGGREGATE, SUMIF, SUMIFS, SUMPRODUCT, MOD, ROUND, INT, ABS |
| Statistical | AVERAGE, COUNT, COUNTA, COUNTIF, COUNTIFS, MAX, MAXIFS, MIN, MINIFS, STDEV |
