...
- Reformatting two- and three-part names, including last-name-first forms, middle-token drops, adjacent first/middle/last column combinations, and initial abbreviations such as `A. Lovelace`, `A. L.`, `Lovelace, Ada`, `Ada B. Lovelace`, and `A. B. Lovelace`.
