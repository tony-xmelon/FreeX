...
- **Spell Check (F7):** Checks the active sheet's text content, including common office, spreadsheet/business-report, operations/planning, calendar/status, report-typo, risk/action tracking, and invoice/supply-chain misspellings such as `availible`, `statment`, `milstone`, `dependancy`, `calandar`, `dedline`, `stauts`, `feild`, `flitered`, `timline`, `risck`, `actoin`, `mitgation`, `escallate`, `custmer`, `invoce`, `paymnt`, and `shippment`.
