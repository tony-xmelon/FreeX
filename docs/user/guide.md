...
- Extracting web and email domain pieces, including hosts, root-domain stems from variable-depth subdomains, ampersand- or semicolon-separated query values, and final URL path segments such as `road-bike?ref=nav` to `road-bike`.
...
- **Spell Check (F7):** Checks the active sheet's text content, including common office, spreadsheet/business-report, data/analytics, sales/marketing/customer, IT/cloud/system, operations/planning, calendar/status, report-typo, risk/action tracking, invoice/supply-chain, meeting/communication, people/HR, legal/compliance, and security/access misspellings such as `availible`, `statment`, `dashbord`, `metrc`, `analytcs`, `campain`, `marketting`, `pipline`, `opportunty`, `deploymnt`, `databse`, `configration`, `syncronize`, `milstone`, `dependancy`, `calandar`, `dedline`, `stauts`, `feild`, `flitered`, `timline`, `risck`, `actoin`, `mitgation`, `escallate`, `custmer`, `invoce`, `paymnt`, `shippment`, `meating`, `agnda`, `communcation`, `notfication`, `employe`, `maneger`, `departmant`, `perfomance`, `complaince`, `polcy`, `contrct`, `privicy`, `confidental`, `securty`, `permisson`, `passwrod`, and `firewal`.
