...
- Extracting or normalizing time-like values, including hour, minute, second, meridiem, embedded time components from labels, embedded 12-hour or 24-hour times, and supported endpoints from two-time ranges.
...
- **Spell Check (F7):** Checks the active sheet's text content, including common office, spreadsheet/business-report, data/analytics, operations/planning, calendar/status, report-typo, risk/action tracking, invoice/supply-chain, meeting/communication, people/HR, legal/compliance, and security/access misspellings such as `availible`, `statment`, `dashbord`, `metrc`, `analytcs`, `milstone`, `dependancy`, `calandar`, `dedline`, `stauts`, `feild`, `flitered`, `timline`, `risck`, `actoin`, `mitgation`, `escallate`, `custmer`, `invoce`, `paymnt`, `shippment`, `meating`, `agnda`, `communcation`, `notfication`, `employe`, `maneger`, `departmant`, `perfomance`, `complaince`, `polcy`, `contrct`, `privicy`, `confidental`, `securty`, `permisson`, `passwrod`, and `firewal`.
