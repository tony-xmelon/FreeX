...
| Category | Examples |
|---|---|
| Math & Trig | SUM, SUBTOTAL, AGGREGATE, SUMIF, SUMIFS, SUMPRODUCT, SERIESSUM, MMULT, MDETERM, MINVERSE |
| Statistical | AVERAGE, COUNT, CORREL, BINOM.DIST, POISSON.DIST, CONFIDENCE.NORM, Z.TEST, RSQ, KURT, TRIMMEAN |
