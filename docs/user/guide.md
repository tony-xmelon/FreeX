...
- Normalizing calendar-valid numeric or English month-name dates, including ordinal day suffixes, month-name date component extraction, and month-name dates embedded in labels.
