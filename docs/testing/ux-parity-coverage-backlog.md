...
| Sheet tabs | Add, rename, delete, duplicate, move, color, hide/unhide, group/ungroup, context menu. Strict paired sheet-tab context and overflow Activate captures now exist in `tools/ux-parity-runs/20260702-015812/ux-scenario-batch.json`; `20260702-012034` is superseded because visual review found a worksheet-menu false positive. | Resolve the Excel overflow Activate reference mismatch, then continue with drag reorder, grouped sheets, keyboard/context-menu routes, and visual review of the paired screenshots. |
