...
| Dialogs | Format Cells, Sort, Data Validation, Page Setup, Insert Function, Find/Replace, Options-style dialogs, invalid input, OK/Cancel/Escape. The current strict core run `tools/ux-parity-runs/20260702-core-activate-list-40-pass/ux-scenario-batch.json` captures improved Excel/FreeX Format Cells parity after tab-order, size, General-description, selected-cell preview, Number-list density, highlight, sample/description width, and compact OK/Cancel fixes. | Continue Format Cells visual tuning for right-pane whitespace/framing and DPI/capture geometry, then convert the pair into a dialog batch with access-key, default button, focus order, and UIA pattern checks. |
...
| Sheet tabs | Add, rename, delete, duplicate, move, color, hide/unhide, group/ungroup, context menu. Strict paired sheet-tab context and real sheet-list overflow Activate captures now exist in `tools/ux-parity-runs/20260702-core-activate-list-40-pass/ux-scenario-batch.json`; `20260702-format-cells-density-pass` is the pre-Activate-density baseline, `20260702-core-after-dialog-fidelity` is the pre-density-pass baseline, `20260702-021746` is the pre-fix baseline, `20260702-012034` is superseded because visual review found a worksheet-menu false positive, and `20260702-015812` is superseded because visual review found the Excel workbook/window Activate fallback. | Continue with sheet-tab context-menu visual parity, remaining Activate selected-row highlight/framing polish, drag reorder, grouped sheets, keyboard/context-menu routes, and broader visual review of the paired screenshots. |
