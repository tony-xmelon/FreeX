...
| Sheet tabs | Add, rename, delete, duplicate, move, color, hide/unhide, group/ungroup, context menu. Strict paired sheet-tab context and real sheet-list overflow Activate captures now exist in `tools/ux-parity-runs/20260702-format-cells-density-pass/ux-scenario-batch.json`; `20260702-core-after-dialog-fidelity` is the pre-density-pass baseline, `20260702-021746` is the pre-fix baseline, `20260702-012034` is superseded because visual review found a worksheet-menu false positive, and `20260702-015812` is superseded because visual review found the Excel workbook/window Activate fallback. | Continue with sheet-tab context-menu visual parity, remaining Activate list-height/selection-framing polish, drag reorder, grouped sheets, keyboard/context-menu routes, and broader visual review of the paired screenshots. |
