...
| Sheet tabs | Add, rename, delete, duplicate, move, color, hide/unhide, group/ungroup, overflow Activate dialog, context menu. | Follow the existing smoke sheet-tab pair with drag reorder, grouped sheets, overflow activation, and keyboard/context-menu routes. |
