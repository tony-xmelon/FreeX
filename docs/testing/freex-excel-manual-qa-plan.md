...
| 21 | `20260831-151324` chart and keytip repair revalidation | Split result | The Excel-authored chart now matches palette and `0-7000`/`1000` auto-axis output in FreeX. Bare-Alt keytips still omit the visible non-Home ribbon-tab map in FreeX despite the worker's focused tests; see `UX-QA-ITER5-001`. |
