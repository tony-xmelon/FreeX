...
subset including scalar comparisons, truthiness predicates, simple `IS*` predicates, simple `IF` wrappers, and simple `XOR` logical wrappers, low-contrast text boxes against
