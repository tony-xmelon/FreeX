...
component extraction that preserves raw month tokens while normalizing ordinal day tokens, pure time component extraction for hour, minute, second, and
...
office, spreadsheet, planning, risk/action, invoice/supply-chain, meeting/communication, and people/HR vocabulary while preserving ignored URL, email,
...
supported currency, ASCII/fullwidth/small percent, accounting-parentheses, and Unicode/fullwidth leading-sign forms, formulas
