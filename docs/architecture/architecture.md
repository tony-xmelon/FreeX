...
labeled text with ambiguous multi-date sources rejected, weekday-prefixed numeric and English month-name date
...
meridiem from time-like values or labeled text with ambiguous component examples rejected, embedded time extraction/normalization with
...
office, spreadsheet, planning, risk/action, invoice/supply-chain, meeting/communication, people/HR, and legal/compliance vocabulary while preserving ignored URL, email,
...
fullwidth digit/comma/decimal forms, supported currency, ASCII/fullwidth/small percent, accounting-parentheses, and Unicode/fullwidth leading-sign forms, formulas
