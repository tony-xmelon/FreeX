...
first-initial/last-name, last-name/first-initial, and single-source plus adjacent-column first/middle/last middle-initial email generation learn constant
