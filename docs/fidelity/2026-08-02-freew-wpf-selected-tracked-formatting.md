...
All Caps, Font Family, Font Size, Character Border, Character Shading, and Clear Formatting now use a
model-backed range command. The command:
...
- `DocumentViewTrackEditTests`: 23/23
