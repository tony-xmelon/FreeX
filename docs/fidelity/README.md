...
Latest PivotTable slice: [2026-06-23-pivottable-visual-metrics-json.md](2026-06-23-pivottable-visual-metrics-json.md) records the machine-readable visual metrics JSON harness and current 16-case evidence ranking; the latest integrated product implementation remains [2026-06-23-pivottable-outline-parent-style-fidelity.md](2026-06-23-pivottable-outline-parent-style-fidelity.md).
