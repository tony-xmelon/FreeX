...
See [parity/command-surface.md](../parity/command-surface.md) for the command-level parity matrix.
See [formats/xlsx-test-corpus-plan.md](xlsx-test-corpus-plan.md) for the Sprint 2 corpus collection and reporting plan.
See [formats/xlsx-corpus-report.md](xlsx-corpus-report.md) for the current executable corpus status.
