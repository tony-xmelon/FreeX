...
3. **Release documentation and packaging**
   ...
   - **Done 2026-06-05:** docs index, project status, and build-history metrics were refreshed for the tester-release run, including the frozen release candidate with Flash Fill URL parent-path/customer-domain coverage, accessibility generic-alt-text coverage, open-smoke/AppIoBench tooling, and Formula pooled-buffer allocation-test stabilization.
