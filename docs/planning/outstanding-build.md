...
1. **XLSX corpus and fidelity proof**
   - Current manifest has 179 rows: 124 generated rows, 25 public Tealeg rows, 21 optional local-private rows, and 9 regression formula-cache workbooks.
