...
1. **XLSX corpus and fidelity proof**
   - Current manifest has 180 rows: 124 generated rows, 25 public rows, 22 optional local-private rows, and 9 regression formula-cache workbooks.
