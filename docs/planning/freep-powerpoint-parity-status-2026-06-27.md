...
Branch/worktree context for this update: `codex/freep-animations-command-planner-20260701`, based on `origin/main` commit `fbd297b73`. This update reflects the 2026-07-01 FreeP parity implementation wave plus the shared Animations command planner slice.
...
The first post-dedup FreeP parity implementation wave is integrated on `main` through `8c78e5535`, with this branch adding shared Animations command planning/exposure. It closed the initial evidence and shared-planning gates that were blocking reliable WPF/Avalonia parity work:
