...
Branch/worktree context for this update: `codex/freep-export-print-depth-20260701`, based on `origin/main` commit `5e87a603`. This update reflects the 2026-07-01 FreeP parity implementation wave plus the shared export/print depth planner slice.
