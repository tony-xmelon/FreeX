...
5. Keep references work shared-first: broader source-manager catalogs/master-source semantics, remaining structured bibliography fields beyond people/corporate authors, TOA page-number/evidence polish, and real references-heavy visual/round-trip proof.
