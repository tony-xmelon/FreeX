...
4. Treat remaining equation work as nested OfficeMath layout, Word-baseline comparison, and geometry/spacing fidelity. The July 7 shared equation planner closes the current modeled-kind fallback layer for both WPF and Avalonia.
