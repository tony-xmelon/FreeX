...
Evidence: [`FormulaEvaluator.Functions`](../src/FreeX.Core.Formula/FormulaEvaluator.Functions.cs#L98) expands range arguments before enforcing max arity at [`line 235`](../src/FreeX.Core.Formula/FormulaEvaluator.Functions.cs#L235).
