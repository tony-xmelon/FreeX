...
- S5 needs additional foreground-owned pointer harness scenarios for physical double-click rename, drag reorder, Ctrl/Shift tab clicks, overflow arrow clicks, and right-click Activate.
