...
- FreeP: 629/629 shared-profile commands with zero actionable host gaps after the final upstream sync. Dialog/pane evidence remains 28/28 pass and whole-window evidence remains 33/33 paired with zero explicit product mismatches.
