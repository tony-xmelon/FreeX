...
- FreeP: 624/624 shared-profile commands with zero actionable host gaps. Dialog/pane evidence remains 28/28 pass and whole-window evidence remains 33/33 paired with zero explicit product mismatches.
