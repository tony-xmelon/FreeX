...
The upstream integration also includes FreeP RTF interior-row-border preservation and Avalonia
nested inline-table rendering. Their focused tests were rerun after the merge.

## Verification

- Repository generated-artifact preflight: passed across 10,278 text files.
- Full serialized Release build: passed, 98 projects, zero warnings and zero errors.
- Full `FreeX.DefaultTests.slnx` Release suite: passed with no failures.
