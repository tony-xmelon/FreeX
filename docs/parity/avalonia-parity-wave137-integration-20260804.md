...
- FreeP remains at zero actionable WPF/Avalonia command-profile gaps and, after the final `main` sync, reports `648/648` shared-profile commands with `109` workflow-evidence rows.
