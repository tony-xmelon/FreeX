...
| FreeW | 98 inventoried route families; 95 represented in comparison rows; 63 paired and 33 Avalonia-only | 283 comparison rows; 183 paired rows; 96 Avalonia-only rows; no PNG manifest | 183 paired rows; 16 pass classifications; 167 genuine visual mismatch classifications | not-present-in-inputs; app-owned comparison rows only; no physical-device or Word-COM artifact in inputs | Microsoft Word: unavailable in inputs; 0 artifacts |
