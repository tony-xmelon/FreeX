...
- **FreeW export:** Avalonia PDF/XPS output now emits page-border operations before page body
  content, including solid, dotted, dashed, and double-rail geometry.
...
- FreeW focused lanes: Backstage **35/35**, Style and Legal Notices **8/8**, Find/Replace **3/3**,
  Page Setup/chrome **45/45**, Multilevel List **3/3**, and PDF export **15/15**.
...
- FreeW PDF export still needs watermark, line-number, and art/wave-border fidelity.
