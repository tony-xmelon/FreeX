...
Chart title and legend rich text are now retained as independent model targets through reader,
writer, clone, shared planner, undo command, and both desktop formatting dialogs.
