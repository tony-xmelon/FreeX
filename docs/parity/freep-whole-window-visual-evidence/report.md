...
|---|---|---|---|---:|---:|---:|---|
| startup.slide | Startup | pass | none | 6.15 % | 4.46 | 1 | [WPF full](wpf/full/startup.slide.png) / [Avalonia full](avalonia/full/startup.slide.png) / [WPF client](wpf/client/startup.slide.png) / [Avalonia client](avalonia/client/startup.slide.png) / [diff](diff/startup.slide.png) |
| startup.notes | Startup | pass | none | 8.04 % | 6.86 | 2 | [WPF full](wpf/full/startup.notes.png) / [Avalonia full](avalonia/full/startup.notes.png) / [WPF client](wpf/client/startup.notes.png) / [Avalonia client](avalonia/client/startup.notes.png) / [diff](diff/startup.notes.png) |
| ribbon.home | StaticRibbonTab | pass | none | 7.94 % | 6.54 | 2 | [WPF full](wpf/full/ribbon.home.png) / [Avalonia full](avalonia/full/ribbon.home.png) / [WPF client](wpf/client/ribbon.home.png) / [Avalonia client](avalonia/client/ribbon.home.png) / [diff](diff/ribbon.home.png) |
| ribbon.insert | StaticRibbonTab | pass | none | 7.60 % | 6.36 | 1 | [WPF full](wpf/full/ribbon.insert.png) / [Avalonia full](avalonia/full/ribbon.insert.png) / [WPF client](wpf/client/ribbon.insert.png) / [Avalonia client](avalonia/client/ribbon.insert.png) / [diff](diff/ribbon.insert.png) |
| ribbon.design | StaticRibbonTab | pass | none | 5.80 % | 5.01 | 1 | [WPF full](wpf/full/ribbon.design.png) / [Avalonia full](avalonia/full/ribbon.design.png) / [WPF client](wpf/client/ribbon.design.png) / [Avalonia client](avalonia/client/ribbon.design.png) / [diff](diff/ribbon.design.png) |
| ribbon.transitions | StaticRibbonTab | pass | none | 9.83 % | 7.46 | 3 | [WPF full](wpf/full/ribbon.transitions.png) / [Avalonia full](avalonia/full/ribbon.transitions.png) / [WPF client](wpf/client/ribbon.transitions.png) / [Avalonia client](avalonia/client/ribbon.transitions.png) / [diff](diff/ribbon.transitions.png) |
| ribbon.animations | StaticRibbonTab | pass | none | 8.18 % | 6.62 | 2 | [WPF full](wpf/full/ribbon.animations.png) / [Avalonia full](avalonia/full/ribbon.animations.png) / [WPF client](wpf/client/ribbon.animations.png) / [Avalonia client](avalonia/client/ribbon.animations.png) / [diff](diff/ribbon.animations.png) |
| ribbon.view | StaticRibbonTab | pass | none | 4.46 % | 4.09 | 1 | [WPF full](wpf/full/ribbon.view.png) / [Avalonia full](avalonia/full/ribbon.view.png) / [WPF client](wpf/client/ribbon.view.png) / [Avalonia client](avalonia/client/ribbon.view.png) / [diff](diff/ribbon.view.png) |
| backstage.info | BackstagePane | pass | none | 1.75 % | 1.69 | 0 | [WPF full](wpf/full/backstage.info.png) / [Avalonia full](avalonia/full/backstage.info.png) / [WPF client](wpf/client/backstage.info.png) / [Avalonia client](avalonia/client/backstage.info.png) / [diff](diff/backstage.info.png) |
| backstage.recent | BackstagePane | pass | none | 7.41 % | 6.94 | 3 | [WPF full](wpf/full/backstage.recent.png) / [Avalonia full](avalonia/full/backstage.recent.png) / [WPF client](wpf/client/backstage.recent.png) / [Avalonia client](avalonia/client/backstage.recent.png) / [diff](diff/backstage.recent.png) |
| backstage.new-from-template | BackstagePane | pass | none | 2.22 % | 1.62 | 0 | [WPF full](wpf/full/backstage.new-from-template.png) / [Avalonia full](avalonia/full/backstage.new-from-template.png) / [WPF client](wpf/client/backstage.new-from-template.png) / [Avalonia client](avalonia/client/backstage.new-from-template.png) / [diff](diff/backstage.new-from-template.png) |
...
| view.zoom-fit | ViewState | pass | none | 5.10 % | 4.57 | 2 | [WPF full](wpf/full/view.zoom-fit.png) / [Avalonia full](avalonia/full/view.zoom-fit.png) / [WPF client](wpf/client/view.zoom-fit.png) / [Avalonia client](avalonia/client/view.zoom-fit.png) / [diff](diff/view.zoom-fit.png) |
| view.zoom-200 | ViewState | pass | none | 5.60 % | 4.52 | 3 | [WPF full](wpf/full/view.zoom-200.png) / [Avalonia full](avalonia/full/view.zoom-200.png) / [WPF client](wpf/client/view.zoom-200.png) / [Avalonia client](avalonia/client/view.zoom-200.png) / [diff](diff/view.zoom-200.png) |
