...
| Flash Fill | Partial | Expanded deterministic inference including common first-name/last-name contact patterns, dotted/underscored/hyphenated email display-name cleanup with plus-address tag removal, plus-address email local-part extraction, email domain-stem extraction, web-address host/domain-stem cleanup from schemes, www prefixes, paths, queries, fragments, and bare hosts, same-name URL query-parameter value extraction with percent/plus decoding, HTTP/HTTPS raw extensionless final-path-segment extraction such as `road-bike?ref=nav` to `road-bike` with percent decoding, HTTP/HTTPS URL slug-to-title inference such as `road-bike.html` or `roadBike.html` to `Road Bike`, digit-mask formatting such as phone-number punctuation, phone-extension extraction from `x`, `ext`, `ext.`, or `extension` markers, thousand-separator stripping, digit-only extraction, final numeric group extraction such as last-four phone/account fragments, calendar-valid embedded-date extraction/normalization from labeled text with ambiguous multi-date sources rejected, embedded time extraction/normalization including 12-hour, 24-hour, and seconds-preserving forms with ambiguous multi-time sources rejected, US address component extraction from abbreviation or full-state-name sources such as street, street number, street name, street without trailing unit/suite, unit/suite suffix, unit/suite identifier, city, normalized state abbreviation, ZIP, ZIP+4 base ZIP, and ZIP+4 extension, two-part full-name reordering, known title/suffix removal, including comma-attached suffix forms such as `Dr. Ada Lovelace`, `Dr. Lovelace`, `Dr. Ada Lovelace Jr., Ph.D.`, `Dr. Ada Lovelace,Jr.,Ph.D.`, `Ada Lovelace Jr.`, `Ada Lovelace,CPA`, or `Lovelace Jr.` to the untitled/unsuffixed name, organization single or stacked legal-suffix removal such as `Northwind Traders LLC`, `Northwind Traders,LLC`, `Northwind Traders, Inc. LLC`, or `Fabrikam Labs,Inc,LLC` to the cleaned organization name, uppercase initial inference from lowercase names, first/last or all-initial abbreviations such as `Ada Lovelace` to `Lovelace, Ada`, `A. Lovelace`, `A. L.`, `Ada L.`, `Lovelace A.`, or `Lovelace, A.`, exactly three-token name edge/middle-token drops, full last-name reordering, and initial abbreviations such as `Ada Byron Lovelace` to `Byron Lovelace`, `Ada Byron`, `Ada Lovelace`, `Lovelace, Ada`, `Lovelace, Ada Byron`, `Ada B. Lovelace`, `A. Lovelace`, `Ada L.`, `Lovelace A.`, `B. Lovelace`, `Byron L.`, `A. B. Lovelace`, `A. B. L.`, `Ada B.`, `Ada Byron L.`, `Lovelace, Ada B.`, `Lovelace A. B.`, `Lovelace, A. B.`, or `B.`, shared-domain email generation with `.`, `_`, or `-` first/last, first-initial/last, first/last-initial, and last/first-initial separators, and first/last-initial email aliases, single-cell invocation includes contiguous examples above the active cell, and selected ranges leave source-blank rows blank while still filling later populated source rows; Excel's full ML-like inference remains partial |
