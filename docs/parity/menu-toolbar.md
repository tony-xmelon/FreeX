...
| Interactive drag handles | Partial | Selected charts, shapes, text boxes, and pictures expose interactive whole-object move/resize/rotation handles through the grid object-selection adornment layer; charts also expose eight live move/resize handles and commit through one undoable SetChartBoundsCommand, including rejected-drop and pointer-capture-cancellation overlay reset; hidden/display-none objects are skipped and selected image crop handles remain supported. Residual gaps: chart rotation is not offered; physical foreground mouse/keytip/dialog-access-key/UIA/Excel-paired proof is incomplete; chart subtarget hit-testing/context menus for chart area, plot area, series/points (except the existing Waterfall point route), axes, titles, and legends remain unsupported. |
