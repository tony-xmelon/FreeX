...
| `table-properties.tab-cell` | captured/captured | **genuine-visual-mismatch** | pass (18.2% painted) | pass (18.0% painted) | 11.47 % | 7.60 |  | heatmaps/table-properties.tab-cell.png |
