...
| `backstage-export.open` | captured/captured | **genuine-visual-mismatch** | pass (11.1% painted) | pass (10.3% painted) | 13.64 % | 10.85 |  | heatmaps/backstage-export.open.png |
...
| `icon-picker.initial` | captured/captured | **genuine-visual-mismatch** | pass (12.7% painted) | pass (10.0% painted) | 12.11 % | 15.33 |  | heatmaps/icon-picker.initial.png |
...
| `legal-notices.initial` | captured/captured | **genuine-visual-mismatch** | pass (8.3% painted) | pass (7.4% painted) | 9.20 % | 9.77 |  | heatmaps/legal-notices.initial.png |
| `legal-notices.tab-legal-notices` | captured/captured | **genuine-visual-mismatch** | pass (14.5% painted) | pass (13.5% painted) | 18.01 % | 18.73 |  | heatmaps/legal-notices.tab-legal-notices.png |
| `legal-notices.tab-privacy-notice` | captured/captured | **genuine-visual-mismatch** | pass (12.6% painted) | pass (12.1% painted) | 16.68 % | 18.67 |  | heatmaps/legal-notices.tab-privacy-notice.png |
| `legal-notices.tab-project-license` | captured/captured | **genuine-visual-mismatch** | pass (8.3% painted) | pass (7.4% painted) | 9.20 % | 9.77 |  | heatmaps/legal-notices.tab-project-license.png |
| `legal-notices.tab-third-party-license-texts` | captured/captured | **genuine-visual-mismatch** | pass (14.5% painted) | pass (13.0% painted) | 18.19 % | 20.03 |  | heatmaps/legal-notices.tab-third-party-license-texts.png |
| `legal-notices.tab-third-party-notices` | captured/captured | **genuine-visual-mismatch** | pass (14.9% painted) | pass (13.1% painted) | 17.83 % | 19.19 |  | heatmaps/legal-notices.tab-third-party-notices.png |
...
| `options.tab-auto-correct` | captured/captured | **genuine-visual-mismatch** | pass (9.1% painted) | pass (10.0% painted) | 11.89 % | 10.06 |  | heatmaps/options.tab-auto-correct.png |
...
| `options.validation-error` | captured/captured | **genuine-visual-mismatch** | pass (5.4% painted) | pass (5.4% painted) | 6.52 % | 4.60 |  | heatmaps/options.validation-error.png |
...
| `table-properties.tab-column` | captured/captured | **pass** | pass (3.3% painted) | pass (2.9% painted) | 2.60 % | 2.10 |  | heatmaps/table-properties.tab-column.png |
| `table-properties.tab-row` | captured/captured | **genuine-visual-mismatch** | pass (6.6% painted) | pass (6.1% painted) | 4.37 % | 3.77 |  | heatmaps/table-properties.tab-row.png |
| `table-properties.tab-table` | captured/captured | **genuine-visual-mismatch** | pass (11.6% painted) | pass (10.4% painted) | 9.01 % | 6.77 |  | heatmaps/table-properties.tab-table.png |
| `table-properties.validation-error` | captured/captured | **genuine-visual-mismatch** | pass (11.6% painted) | pass (10.5% painted) | 9.12 % | 6.91 |  | heatmaps/table-properties.validation-error.png |
