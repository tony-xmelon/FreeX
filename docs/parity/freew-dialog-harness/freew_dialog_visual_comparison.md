...
| `page-setup.initial` | captured/captured | **genuine-visual-mismatch** | pass (14.6% painted) | pass (14.8% painted) | 9.57 % | 5.52 |  | heatmaps/page-setup.initial.png |
| `page-setup.populated` | captured/captured | **genuine-visual-mismatch** | pass (14.6% painted) | pass (14.8% painted) | 9.57 % | 5.52 |  | heatmaps/page-setup.populated.png |
| `page-setup.tab-layout` | captured/captured | **genuine-visual-mismatch** | pass (8.6% painted) | pass (8.8% painted) | 6.64 % | 4.30 |  | heatmaps/page-setup.tab-layout.png |
| `page-setup.tab-margins` | captured/captured | **genuine-visual-mismatch** | pass (14.6% painted) | pass (14.8% painted) | 9.57 % | 5.52 |  | heatmaps/page-setup.tab-margins.png |
| `page-setup.tab-paper` | captured/captured | **genuine-visual-mismatch** | pass (5.0% painted) | pass (5.2% painted) | 4.30 % | 2.64 |  | heatmaps/page-setup.tab-paper.png |
| `page-setup.validation-error` | captured/captured | **genuine-visual-mismatch** | pass (14.6% painted) | pass (14.8% painted) | 9.68 % | 5.65 |  | heatmaps/page-setup.validation-error.png |
...
| `symbol-picker.initial` | captured/captured | **genuine-visual-mismatch** | pass (3.3% painted) | pass (32.5% painted) | 32.60 % | 11.75 | focus | heatmaps/symbol-picker.initial.png |
