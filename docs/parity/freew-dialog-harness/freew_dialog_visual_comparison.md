...
| `font.initial` | captured/captured | **genuine-visual-mismatch** | pass (11.5% painted) | pass (9.7% painted) | 10.79 % | 9.38 |  | heatmaps/font.initial.png |
| `font.populated` | captured/captured | **genuine-visual-mismatch** | pass (11.5% painted) | pass (9.7% painted) | 10.88 % | 9.48 |  | heatmaps/font.populated.png |
| `font.validation-error` | captured/captured | **genuine-visual-mismatch** | pass (11.6% painted) | pass (9.8% painted) | 11.03 % | 9.68 |  | heatmaps/font.validation-error.png |
