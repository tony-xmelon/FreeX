...
| `font.initial` | captured/captured | **genuine-visual-mismatch** | pass (11.5% painted) | pass (9.7% painted) | 8.36 % | 7.05 |  | heatmaps/font.initial.png |
| `font.populated` | captured/captured | **genuine-visual-mismatch** | pass (11.5% painted) | pass (9.7% painted) | 8.45 % | 7.14 |  | heatmaps/font.populated.png |
| `font.validation-error` | captured/captured | **genuine-visual-mismatch** | pass (11.6% painted) | pass (9.8% painted) | 8.56 % | 7.29 |  | heatmaps/font.validation-error.png |
