...
| `backstage-account.open` | captured/captured | **genuine-visual-mismatch** | pass (2.7% painted) | pass (2.5% painted) | 4.09 % | 4.59 | action-button-order | heatmaps/backstage-account.open.png |
...
| `backstage-open.open` | captured/captured | **genuine-visual-mismatch** | pass (12.7% painted) | pass (10.7% painted) | 20.69 % | 17.82 | action-button-order | heatmaps/backstage-open.open.png |
| `backstage-options.open` | captured/captured | **genuine-visual-mismatch** | pass (1.8% painted) | pass (2.0% painted) | 3.00 % | 3.29 | action-button-order | heatmaps/backstage-options.open.png |
...
| `bookmark-manager.initial` | captured/captured | **genuine-visual-mismatch** | pass (2.8% painted) | pass (2.6% painted) | 3.12 % | 1.91 | cancel-button,action-button-order | heatmaps/bookmark-manager.initial.png |
| `bookmark-manager.populated` | captured/captured | **genuine-visual-mismatch** | pass (2.8% painted) | pass (2.6% painted) | 3.12 % | 1.91 | cancel-button,action-button-order | heatmaps/bookmark-manager.populated.png |
| `bookmark-manager.validation-error` | captured/captured | **genuine-visual-mismatch** | pass (2.8% painted) | pass (2.6% painted) | 3.12 % | 1.91 | cancel-button,action-button-order | heatmaps/bookmark-manager.validation-error.png |
...
| `building-blocks-organizer.initial` | captured/captured | **genuine-visual-mismatch** | pass (3.5% painted) | pass (2.5% painted) | 6.07 % | 4.83 | default-button,cancel-button,action-button-order | heatmaps/building-blocks-organizer.initial.png |
| `building-blocks-organizer.populated` | captured/captured | **genuine-visual-mismatch** | pass (3.5% painted) | pass (2.5% painted) | 6.09 % | 4.85 | default-button,cancel-button,action-button-order | heatmaps/building-blocks-organizer.populated.png |
| `building-blocks-organizer.validation-error` | captured/captured | **genuine-visual-mismatch** | pass (3.5% painted) | pass (2.4% painted) | 6.09 % | 4.88 | default-button,cancel-button,action-button-order | heatmaps/building-blocks-organizer.validation-error.png |
| `cell-shading.initial` | captured/captured | **semantic-mismatch** | pass (2.4% painted) | pass (2.6% painted) | 1.97 % | 1.50 | action-button-order | heatmaps/cell-shading.initial.png |
...
| `find-replace.initial` | captured/captured | **genuine-visual-mismatch** | pass (8.7% painted) | pass (7.3% painted) | 15.18 % | 8.09 | action-button-order | heatmaps/find-replace.initial.png |
| `find-replace.populated` | captured/captured | **genuine-visual-mismatch** | pass (8.7% painted) | pass (7.1% painted) | 15.08 % | 8.09 | action-button-order | heatmaps/find-replace.populated.png |
| `find-replace.validation-error` | captured/captured | **genuine-visual-mismatch** | pass (8.8% painted) | pass (7.3% painted) | 15.27 % | 8.26 | action-button-order | heatmaps/find-replace.validation-error.png |
| `font.initial` | captured/captured | **genuine-visual-mismatch** | pass (12.4% painted) | pass (16.3% painted) | 17.15 % | 13.48 | default-button,cancel-button | heatmaps/font.initial.png |
| `font.populated` | captured/captured | **genuine-visual-mismatch** | pass (12.5% painted) | pass (16.3% painted) | 17.22 % | 13.60 | default-button,cancel-button | heatmaps/font.populated.png |
| `font.tab-advanced` | captured/captured | **genuine-visual-mismatch** | pass (17.8% painted) | pass (16.2% painted) | 15.94 % | 12.14 | default-button,cancel-button | heatmaps/font.tab-advanced.png |
| `font.tab-font` | captured/captured | **genuine-visual-mismatch** | pass (12.4% painted) | pass (16.3% painted) | 17.15 % | 13.48 | default-button,cancel-button | heatmaps/font.tab-font.png |
| `font.validation-error` | captured/captured | **genuine-visual-mismatch** | pass (12.6% painted) | pass (16.5% painted) | 17.44 % | 13.87 | default-button,cancel-button | heatmaps/font.validation-error.png |
| `footnote-endnote-options.initial` | captured/captured | **genuine-visual-mismatch** | pass (14.9% painted) | pass (5.2% painted) | 17.59 % | 7.63 | default-button,cancel-button | heatmaps/footnote-endnote-options.initial.png |
| `footnote-endnote-options.populated` | captured/captured | **genuine-visual-mismatch** | pass (14.9% painted) | pass (5.8% painted) | 18.05 % | 8.02 | default-button,cancel-button | heatmaps/footnote-endnote-options.populated.png |
| `footnote-endnote-options.validation-error` | captured/captured | **genuine-visual-mismatch** | pass (15.0% painted) | pass (5.9% painted) | 18.01 % | 8.52 | default-button,cancel-button | heatmaps/footnote-endnote-options.validation-error.png |
...
| `icon-picker.initial` | captured/captured | **genuine-visual-mismatch** | pass (12.7% painted) | pass (8.1% painted) | 13.69 % | 19.87 | default-button,cancel-button,action-button-order | heatmaps/icon-picker.initial.png |
| `icon-picker.populated` | captured/captured | **semantic-mismatch** | pass (2.4% painted) | pass (2.4% painted) | 1.28 % | 1.28 | default-button,cancel-button,action-button-order | heatmaps/icon-picker.populated.png |
| `icon-picker.validation-error` | captured/captured | **semantic-mismatch** | pass (2.5% painted) | pass (2.5% painted) | 1.37 % | 1.40 | default-button,cancel-button,action-button-order | heatmaps/icon-picker.validation-error.png |
...
| `insert-smart-art.initial` | captured/captured | **genuine-visual-mismatch** | pass (11.3% painted) | pass (8.9% painted) | 11.60 % | 6.05 | action-button-order | heatmaps/insert-smart-art.initial.png |
| `insert-smart-art.populated` | captured/captured | **genuine-visual-mismatch** | pass (11.3% painted) | pass (8.9% painted) | 11.60 % | 6.05 | action-button-order | heatmaps/insert-smart-art.populated.png |
| `insert-smart-art.validation-error` | captured/captured | **genuine-visual-mismatch** | pass (7.8% painted) | pass (5.4% painted) | 8.29 % | 5.43 | action-button-order | heatmaps/insert-smart-art.validation-error.png |
...
| `manage-styles.initial` | captured/captured | **genuine-visual-mismatch** | pass (7.5% painted) | pass (7.7% painted) | 6.45 % | 3.85 | default-button,cancel-button,action-button-order | heatmaps/manage-styles.initial.png |
| `manage-styles.populated` | captured/captured | **genuine-visual-mismatch** | pass (7.5% painted) | pass (7.7% painted) | 6.45 % | 3.85 | default-button,cancel-button,action-button-order | heatmaps/manage-styles.populated.png |
| `manage-styles.validation-error` | captured/captured | **genuine-visual-mismatch** | pass (7.5% painted) | pass (7.7% painted) | 6.45 % | 3.85 | default-button,cancel-button,action-button-order | heatmaps/manage-styles.validation-error.png |
...
| `multilevel-list.initial` | captured/captured | **genuine-visual-mismatch** | pass (24.2% painted) | pass (26.7% painted) | 14.61 % | 10.16 | default-button,cancel-button,action-button-order | heatmaps/multilevel-list.initial.png |
| `multilevel-list.populated` | captured/captured | **genuine-visual-mismatch** | pass (24.2% painted) | pass (26.7% painted) | 14.61 % | 10.16 | default-button,cancel-button,action-button-order | heatmaps/multilevel-list.populated.png |
| `multilevel-list.validation-error` | captured/captured | **genuine-visual-mismatch** | pass (24.2% painted) | pass (26.9% painted) | 14.79 % | 10.36 | default-button,cancel-button,action-button-order | heatmaps/multilevel-list.validation-error.png |
...
| `paragraph.initial` | captured/captured | **genuine-visual-mismatch** | pass (14.1% painted) | pass (17.4% painted) | 17.76 % | 17.48 | default-button,cancel-button,action-button-order | heatmaps/paragraph.initial.png |
| `paragraph.populated` | captured/captured | **genuine-visual-mismatch** | pass (14.1% painted) | pass (17.4% painted) | 17.76 % | 17.48 | default-button,cancel-button,action-button-order | heatmaps/paragraph.populated.png |
...
| `paste-special.initial` | captured/captured | **genuine-visual-mismatch** | pass (13.3% painted) | pass (14.2% painted) | 8.85 % | 9.11 | default-button,cancel-button | heatmaps/paste-special.initial.png |
| `paste-special.populated` | captured/captured | **genuine-visual-mismatch** | pass (13.3% painted) | pass (14.2% painted) | 8.85 % | 9.11 | default-button,cancel-button | heatmaps/paste-special.populated.png |
| `paste-special.validation-error` | captured/captured | **genuine-visual-mismatch** | pass (13.3% painted) | pass (14.2% painted) | 8.85 % | 9.11 | default-button,cancel-button | heatmaps/paste-special.validation-error.png |
...
| `restrict-editing.initial` | captured/captured | **genuine-visual-mismatch** | pass (5.8% painted) | pass (5.3% painted) | 10.71 % | 7.43 | default-button,cancel-button,action-button-order | heatmaps/restrict-editing.initial.png |
| `restrict-editing.populated` | captured/captured | **genuine-visual-mismatch** | pass (5.8% painted) | pass (5.3% painted) | 10.73 % | 7.45 | default-button,cancel-button,action-button-order | heatmaps/restrict-editing.populated.png |
| `restrict-editing.validation-error` | captured/captured | **genuine-visual-mismatch** | pass (5.8% painted) | pass (5.3% painted) | 10.76 % | 7.48 | default-button,cancel-button,action-button-order | heatmaps/restrict-editing.validation-error.png |
...
| `style.initial` | captured/captured | **genuine-visual-mismatch** | pass (25.8% painted) | pass (26.1% painted) | 18.49 % | 11.28 | default-button,cancel-button | heatmaps/style.initial.png |
| `style.populated` | captured/captured | **genuine-visual-mismatch** | pass (25.8% painted) | pass (26.3% painted) | 18.68 % | 11.51 | default-button,cancel-button | heatmaps/style.populated.png |
| `style.validation-error` | captured/captured | **genuine-visual-mismatch** | pass (25.8% painted) | pass (26.3% painted) | 18.70 % | 11.52 | default-button,cancel-button | heatmaps/style.validation-error.png |
| `symbol-picker.initial` | captured/captured | **semantic-mismatch** | pass (32.9% painted) | pass (33.0% painted) | 2.09 % | 1.72 | focus,cancel-button,action-button-order | heatmaps/symbol-picker.initial.png |
...
| `table-properties.initial` | captured/captured | **genuine-visual-mismatch** | pass (11.6% painted) | pass (8.4% painted) | 13.62 % | 9.41 | focus | heatmaps/table-properties.initial.png |
| `table-properties.populated` | captured/captured | **genuine-visual-mismatch** | pass (11.6% painted) | pass (8.5% painted) | 13.75 % | 9.61 | focus | heatmaps/table-properties.populated.png |
| `table-properties.tab-cell` | captured/captured | **genuine-visual-mismatch** | pass (8.1% painted) | pass (6.5% painted) | 9.86 % | 7.41 | focus | heatmaps/table-properties.tab-cell.png |
| `table-properties.tab-column` | captured/captured | **genuine-visual-mismatch** | pass (3.2% painted) | pass (3.2% painted) | 3.32 % | 2.85 | focus | heatmaps/table-properties.tab-column.png |
| `table-properties.tab-row` | captured/captured | **genuine-visual-mismatch** | pass (6.4% painted) | pass (5.4% painted) | 7.19 % | 5.35 | focus | heatmaps/table-properties.tab-row.png |
| `table-properties.tab-table` | captured/captured | **genuine-visual-mismatch** | pass (11.6% painted) | pass (8.4% painted) | 13.62 % | 9.41 | focus | heatmaps/table-properties.tab-table.png |
| `table-properties.validation-error` | captured/captured | **genuine-visual-mismatch** | pass (11.6% painted) | pass (8.9% painted) | 14.41 % | 10.14 | focus | heatmaps/table-properties.validation-error.png |
