...
| `font.initial` | captured/captured | **genuine-visual-mismatch** | pass (11.5% painted) | pass (10.1% painted) | 10.99 % | 9.38 |  | heatmaps/font.initial.png |
| `font.populated` | captured/captured | **genuine-visual-mismatch** | pass (11.5% painted) | pass (10.2% painted) | 11.09 % | 9.48 |  | heatmaps/font.populated.png |
| `font.validation-error` | captured/captured | **genuine-visual-mismatch** | pass (11.6% painted) | pass (10.3% painted) | 11.25 % | 9.67 |  | heatmaps/font.validation-error.png |
...
| `legal-notices.initial` | captured/captured | **genuine-visual-mismatch** | pass (7.7% painted) | pass (7.0% painted) | 8.42 % | 9.18 |  | heatmaps/legal-notices.initial.png |
| `legal-notices.tab-legal-notices` | captured/captured | **genuine-visual-mismatch** | pass (14.6% painted) | pass (13.2% painted) | 18.78 % | 21.16 |  | heatmaps/legal-notices.tab-legal-notices.png |
| `legal-notices.tab-privacy-notice` | captured/captured | **genuine-visual-mismatch** | pass (13.2% painted) | pass (12.2% painted) | 16.64 % | 18.28 |  | heatmaps/legal-notices.tab-privacy-notice.png |
| `legal-notices.tab-project-license` | captured/captured | **genuine-visual-mismatch** | pass (7.7% painted) | pass (7.0% painted) | 8.42 % | 9.19 |  | heatmaps/legal-notices.tab-project-license.png |
| `legal-notices.tab-third-party-license-texts` | captured/captured | **genuine-visual-mismatch** | pass (14.2% painted) | pass (13.2% painted) | 17.92 % | 20.17 |  | heatmaps/legal-notices.tab-third-party-license-texts.png |
| `legal-notices.tab-third-party-notices` | captured/captured | **genuine-visual-mismatch** | pass (14.3% painted) | pass (12.7% painted) | 17.17 % | 19.06 |  | heatmaps/legal-notices.tab-third-party-notices.png |
...
| `table-properties.initial` | captured/captured | **genuine-visual-mismatch** | pass (10.7% painted) | pass (9.5% painted) | 9.42 % | 6.77 |  | heatmaps/table-properties.initial.png |
| `table-properties.populated` | captured/captured | **genuine-visual-mismatch** | pass (10.7% painted) | pass (9.5% painted) | 9.42 % | 6.77 |  | heatmaps/table-properties.populated.png |
| `table-properties.tab-cell` | captured/captured | **genuine-visual-mismatch** | pass (17.3% painted) | pass (17.0% painted) | 11.89 % | 7.69 |  | heatmaps/table-properties.tab-cell.png |
| `table-properties.tab-column` | captured/captured | **pass** | pass (2.4% painted) | pass (2.0% painted) | 2.70 % | 2.20 |  | heatmaps/table-properties.tab-column.png |
| `table-properties.tab-row` | captured/captured | **genuine-visual-mismatch** | pass (5.7% painted) | pass (5.2% painted) | 4.56 % | 3.75 |  | heatmaps/table-properties.tab-row.png |
| `table-properties.tab-table` | captured/captured | **genuine-visual-mismatch** | pass (10.7% painted) | pass (9.5% painted) | 9.42 % | 6.77 |  | heatmaps/table-properties.tab-table.png |
| `table-properties.validation-error` | captured/captured | **genuine-visual-mismatch** | pass (10.7% painted) | pass (9.5% painted) | 9.53 % | 6.90 |  | heatmaps/table-properties.validation-error.png |
