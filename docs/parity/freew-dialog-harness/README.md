...
- Comparison: 155 genuine visual mismatches, 28 visual passes, 105 Avalonia extensions, and 7 state-not-applicable rows. There are zero semantic-only, invalid-capture-content, host-missing, or product-gap rows.
