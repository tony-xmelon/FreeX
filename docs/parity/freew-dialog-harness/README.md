...
- Comparison: 170 genuine visual mismatches, 13 visual passes, 96 Avalonia extensions, and 4 state-not-applicable rows. There are zero semantic-only, invalid-capture-content, host-missing, or product-gap rows.
