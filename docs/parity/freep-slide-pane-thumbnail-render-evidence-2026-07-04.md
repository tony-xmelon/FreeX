...
- `tools/FreeP.RenderCompare.Tests/SlidePaneThumbnailEvidenceTests.cs` pins the evidence plan dimensions, artifact routes, and renderer/baseline file-set collection.
