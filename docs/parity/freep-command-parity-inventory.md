...
Raw missing counts preserve one-sided generated profile surface counts. Actionable missing counts exclude platform-only commands so Avalonia shell commands are not reported as WPF or Avalonia implementation gaps.
