...
| **Theme-color effects are partial** | Full OOXML theme-effect chains (glow, reflection, bevel, etc.) are not interpreted; base theme colors plus current non-chart theme-shadow defaults are applied. |
