...
| **Theme-color effects are partial** | Full OOXML theme-effect chains (reflection, bevel, 3D, etc.) are not interpreted; base theme colors plus bounded non-chart theme shadow, glow, and soft-edge defaults are applied. |
