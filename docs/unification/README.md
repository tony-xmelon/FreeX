...
> **Status (2026-08-09):** the foundational program and later renderer-dedup campaigns have landed.
> This is the living architecture record; dated execution evidence is in `LOG.md`, and residual measurement
> is generated by `tools/Measure-DedupResiduals.ps1`.
