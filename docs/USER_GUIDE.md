...
- Extracting or removing delimiter-based tokens, including final dotted tokens such as file extensions, variable-depth final hyphen/slash/backslash/underscore segments, and bracketed qualifiers.
