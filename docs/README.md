...
- [CHARTS_EXCEL_FREEX_COMPARISON_2026-06-01.md](CHARTS_EXCEL_FREEX_COMPARISON_2026-06-01.md) - current chart interop evidence, including the 28/28 latest-complete Excel openability/export and visual-gate pass.
