...
- [release/installation-and-browser-support.md](release/installation-and-browser-support.md) - desktop installation steps, Chromium/browser release status, and additional OS support options.
