...
- [history/status-2026-06-05.md](history/status-2026-06-05.md) - current status snapshot covering June 5 XLSX package-fidelity, v1 parity reliability/accessibility batches, test-helper consolidation, docs/metrics, and tester-release preparation.
