...
- [history/status-2026-06-06.md](history/status-2026-06-06.md) - current status snapshot covering the v0.8.88 daily tester release, frozen release commit, and hosted gate evidence.
