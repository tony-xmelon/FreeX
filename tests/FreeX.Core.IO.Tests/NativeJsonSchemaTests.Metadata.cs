...
public sealed partial class NativeJsonSchemaTests
{
    ...
    {
        var loadSource = TestWorkspaceFiles.ReadCoreIoSource("NativeJsonAdapter.cs");
        var saveSource = TestWorkspaceFiles.ReadCoreIoSource("NativeJsonAdapter.Save.cs");
        var mapperSource = TestWorkspaceFiles.ReadCoreIoSource("NativeJsonAdapter.MetadataMapping.cs");
        var workbookFileMetadataSource = TestWorkspaceFiles.ReadCoreIoSource("NativeJsonAdapter.WorkbookFileMetadata.cs");
        ...
        var workbookViewSource = TestWorkspaceFiles.ReadCoreIoSource("NativeJsonAdapter.WorkbookViewMetadata.cs");
        ...
        var smartTagSource = TestWorkspaceFiles.ReadCoreIoSource("NativeJsonAdapter.WorkbookSmartTags.cs");
