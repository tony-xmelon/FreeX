...
public sealed partial class XlsxChartExWriterTests
{
        ...
        bool expectParetoLine = false)
    {
        ...
        using (var archive = new ZipArchive(saved, ZipArchiveMode.Read, leaveOpen: true))
        {
            ...
            var contentTypesXml = XlsxPackageTestFixtures.LoadPackageXml(archive.GetEntry("[Content_Types].xml")!);
            ...
            var drawingRelsXml = XlsxPackageTestFixtures.LoadPackageXml(archive.GetEntry("xl/drawings/_rels/drawing1.xml.rels")!);
            ...
            var chartRelsXml = XlsxPackageTestFixtures.LoadPackageXml(archive.GetEntry("xl/charts/_rels/chart1.xml.rels")!);
            chartRelsXml.Root!
                .Elements(PackageRelNs + "Relationship")
                .Where(element =>
            ...
            var styleXml = XlsxPackageTestFixtures.LoadPackageXml(archive.GetEntry("xl/charts/style1.xml")!);
            styleXml.Root!.Name.Should().Be(ChartStyleNs + "chartStyle");
            AssertExcelNativeChartExStyle(styleXml);

            var colorsXml = XlsxPackageTestFixtures.LoadPackageXml(archive.GetEntry("xl/charts/colors1.xml")!);
            ...
            var drawingXml = XlsxPackageTestFixtures.LoadPackageXml(archive.GetEntry("xl/drawings/drawing1.xml")!);
