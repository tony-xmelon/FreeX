...
public sealed class AvaloniaShellSourceTests
{
    ...
    public void MainWindow_WiresSheetLifecycleThroughSharedWorkbookSession()
    {
        ...
        source.Should().Contain("private const string SheetTabContextHelpText = \"Selects this sheet. Right-click or press Shift+F10 for sheet tab options.\";");
        source.Should().Contain("Focusable = true,");
        ...
        source.Should().Contain("button.KeyDown += (_, args) => OpenSheetTabContextMenuFromKeyboard(tab.Id, button, args);");
