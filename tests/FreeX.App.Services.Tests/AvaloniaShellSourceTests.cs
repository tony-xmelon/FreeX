...
public sealed class AvaloniaShellSourceTests
{
    ...
    public void MainWindow_WiresWorkbookSharePlannerToAvaloniaFallback()
    {
        ...
        source.Should().Contain("DocumentShareActionPlanner.CreatePlan(");
        ...
        source.Should().Contain("case DocumentShareActionPlanKind.SaveAsBeforeShare:");
        source.Should().Contain("await SaveWorkbookAsAsync();");
        source.Should().Contain("case DocumentShareActionPlanKind.OpenContainingFolder:");
        ...
        source.Should().Contain("case DocumentShareActionPlanKind.ShareSheet:");
        source.Should().Contain("await ShowWorkbookShareSheetAsync(plan);");
        source.Should().Contain("private async Task ShowWorkbookShareSheetAsync(DocumentShareActionPlan plan)");
        source.Should().Contain("if (refreshedPlan.Kind != DocumentShareActionPlanKind.ShareSheet)");
        ...
        source.Should().Contain("case DocumentShareActionPlanKind.Deferred:");
        source.Should().Contain("FormatWorkbookShareStatus(plan)");
        source.Should().Contain("DocumentShareActionTextSpec.WorkbookEnglish");
        ...
        source.Should().Contain("DocumentShareActionUnavailableReason.ContainingFolderUnavailable");
    ...
    public void MainWindow_WiresNativeFileMenuToSharedOpenSavePipeline()
    {
        ...
        source.Should().Contain("ApplySelectedRangeTextRotation(0, UiText.Get(\"TextRotation_HorizontalSuccessAction\"), UiText.Get(\"MainLoc_AlignmentFailed\"));");
        ...
        source.Should().Contain("ApplySelectedRangeTextRotation(45, UiText.Get(\"TextRotation_CounterclockwiseSuccessAction\"), UiText.Get(\"MainLoc_AlignmentFailed\"));");
        catalogSource.Should().Contain("new(NativeMenuItemId.AngleClockwise, \"Angle Clockwise\", RequiresGestureInSmoke: false)");
        source.Should().Contain("ApplySelectedRangeTextRotation(-45, UiText.Get(\"TextRotation_ClockwiseSuccessAction\"), UiText.Get(\"MainLoc_AlignmentFailed\"));");
        catalogSource.Should().Contain("new(NativeMenuItemId.VerticalText, \"Vertical Text\", RequiresGestureInSmoke: false)");
        source.Should().Contain("ApplySelectedRangeTextRotation(255, UiText.Get(\"TextRotation_VerticalSuccessAction\"), UiText.Get(\"MainLoc_AlignmentFailed\"));");
        catalogSource.Should().Contain("new(NativeMenuItemId.RotateTextUp, \"Rotate Text Up\", RequiresGestureInSmoke: false)");
        source.Should().Contain("ApplySelectedRangeTextRotation(90, UiText.Get(\"TextRotation_UpSuccessAction\"), UiText.Get(\"MainLoc_AlignmentFailed\"));");
        catalogSource.Should().Contain("new(NativeMenuItemId.RotateTextDown, \"Rotate Text Down\", RequiresGestureInSmoke: false)");
        source.Should().Contain("ApplySelectedRangeTextRotation(-90, UiText.Get(\"TextRotation_DownSuccessAction\"), UiText.Get(\"MainLoc_AlignmentFailed\"));");
        ...
        source.Should().Contain("UiText.Get(\"MainWindow_Text_Zoom\")");
    ...
    public void MainWindow_RendersBasicDrawingObjectPreviewOverlay()
    {
        ...
        source.Should().Contain("\"RecentFile_AutomationNameFormat\",");
    ...
    public void MainWindow_WiresAutoSumMenuThroughSharedWorkbookSession()
    {
        ...
        source.Should().Contain("\"MainLoc_ActionRangeStatusFormat\",");
    ...
    public void WpfParityCapture_RegistersSameDialogSurfaceIdsAsAvalonia()
    {
        ...
        var dialogIds = new[]
        {
            ...
            "dialog.InsertSlicerDialog",
            "dialog.InsertTimelineDialog",
            "dialog.AllowEditRangeDialog",
            "dialog.ConfirmPasswordDialog",
            "dialog.ProtectWorkbook",
            "dialog.AccessibilityCheckerDialog",
            "dialog.DataValidationDialog",
            "dialog.ConditionalFormatDialog",
    ...
    public void MainWindow_WiresTextRotationThroughSharedWorkbookSession()
    {
        ...
        source.Should().Contain("CreateTextRotationMenuItem(UiText.Get(\"MainWindow_Header_Horizontal\"), 0, UiText.Get(\"TextRotation_HorizontalSuccessAction\"), UiText.Get(\"MainLoc_AlignmentFailed\"))");
        source.Should().Contain("CreateTextRotationMenuItem(UiText.Get(\"MainWindow_Header_AngleClockwise\"), -45, UiText.Get(\"TextRotation_ClockwiseSuccessAction\"), UiText.Get(\"MainLoc_AlignmentFailed\"))");
    ...
    public void MainWindow_WiresCompactFormatCellsRouteThroughSharedWorkbookSession()
    {
        ...
        source.Should().Contain("new FormatCellsCompactDialogInput(");
        source.Should().Contain("FormatCellsDialogPlanner.TryCreateCompactPlan(plannerInput");
        source.Should().Contain("UseNormalFont: normalFont");
        source.Should().Contain("Underline: underlineBox.IsChecked == true");
        source.Should().Contain("Bold: boldBox.IsChecked == true");
        source.Should().Contain("FontNameText: fontNameBox.Text");
        source.Should().Contain("FontColor: (fontColorBox.SelectedItem as FormatCellsColorChoice)?.Color");
        source.Should().Contain("SelectFormatCellsColor(fontColorBox, normal.FontColor)");
        source.Should().Contain("MergeCells: mergeCellsBox.IsChecked == true");
        source.Should().Contain("FillPatternStyle: SelectedFormatCellsValue(currentFillStyle.FillPatternStyle, fillPatternStyleBox)");
        source.Should().Contain("FillPatternColorText: fillEditor.PatternColorTextBox.Text");
