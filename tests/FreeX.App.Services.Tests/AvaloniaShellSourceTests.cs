...
public sealed class AvaloniaShellSourceTests
{
    ...
    public void MainWindow_WiresSheetLifecycleThroughSharedWorkbookSession()
    {
        ...
        source.Should().Contain("private const string SheetTabContextHelpText = \"Selects this sheet. Press F6 to focus sheet tabs, use arrow keys to switch sheets, or right-click/press Shift+F10 for sheet tab options.\";");
        source.Should().Contain("Focusable = true,");
        ...
        source.Should().Contain("private void FocusActiveSheetTab()");
        ...
        source.Should().Contain("private static bool IsSheetTabFocusKey(KeyEventArgs args)");
        source.Should().Contain("args.Key == Key.F6 &&");
        source.Should().Contain("if (IsSheetTabFocusKey(e))");
        source.Should().Contain("FocusActiveSheetTab();");
