...
public sealed class AvaloniaShellSourceTests
{
    ...
    public void MainWindow_WiresFindGoToThroughSharedWorkbookSession()
    {
        ...
        source.Should().Contain("private FindOptions CreateFindOptions(FindOptionsControls controls)");
        ...
        sessionSource.Should().Contain("new EditCellsCommand(pair.Key, pair.Value)");
