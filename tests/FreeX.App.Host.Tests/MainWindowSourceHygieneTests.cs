...
public sealed class MainWindowSourceHygieneTests
{
    ...
    public void SheetTabs_UseContextualNavigationArrowsInsteadOfAHorizontalScrollbar()
    {
        ...
        xaml.Should().Contain("MinHeight=\"31\"");
        xaml.Should().Contain("Height=\"32\"");
        xaml.Should().Contain("MinHeight=\"32\"");
        ...
        xaml.Should().Contain("Width=\"28\" Height=\"28\"");
        xaml.Should().Contain("Data=\"M 9,1 L 5,5 L 9,9\"");
        xaml.Should().Contain("Data=\"M 5,1 L 9,5 L 5,9\"");
        xaml.Should().Contain("x:Name=\"SheetTabsLeftEdgeMask\"");
        xaml.Should().Contain("x:Name=\"SheetTabsRightEdgeMask\"");
        xaml.Should().Contain("x:Name=\"SheetTabsViewportMaskLayer\"");
        xaml.Should().Contain("x:Name=\"SheetTabsLeftViewportMask\"");
        xaml.Should().Contain("x:Name=\"SheetTabsRightViewportMask\"");
        xaml.Should().Contain("Width=\"{Binding ActualWidth, ElementName=SheetTabsScroller}\"");
        xaml.Should().Contain("Height=\"30\"");
        ...
        source.Should().Contain("UpdateSheetTabsViewportEdgeMasks(canScrollLeft, canScrollRight);");
        source.Should().Contain("Math.Min(MeasureLeftClippedSheetTabWidth(), 72)");
        source.Should().Contain("MeasureLeftClippedSheetTabWidth");
        ...
        navigationSource.Should().Contain("SheetTabsLeftEdgeMask.Visibility = canScrollLeft ? Visibility.Visible : Visibility.Hidden;");
        navigationSource.Should().Contain("SheetTabsRightEdgeMask.Visibility = canScroll ? Visibility.Visible : Visibility.Hidden;");
