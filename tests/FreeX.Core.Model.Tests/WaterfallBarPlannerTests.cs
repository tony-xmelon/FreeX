...
public sealed class WaterfallBarPlannerTests
{
    ...
    {
        WaterfallBarPlanner.Compute([], totalIndices: null).Should().BeEmpty();
    }

    [Fact]
    public void Increases_StackCumulativelyFromZero()
    {
        var bars = WaterfallBarPlanner.Compute([10, 20, 30], totalIndices: []);
    ...
    {
        var bars = WaterfallBarPlanner.Compute([10, -4], totalIndices: []);
    ...
    public void TotalPoint_DrawsFromZeroToTheCumulativeRunningValueIgnoringItsOwnCellValue()
    {
        ...
        var bars = WaterfallBarPlanner.Compute([10, 20, 99], totalIndices: [2]);
    ...
    {
        var bars = WaterfallBarPlanner.Compute([10, 20, 0, 5], totalIndices: [2]);
    ...
    {
        var bars = WaterfallBarPlanner.Compute([10, 20, 30], totalIndices: null);
    ...
    public void MultipleTotals_EachShowsTheRunningCumulativeAtThatPoint()
    {
        ...
        var bars = WaterfallBarPlanner.Compute([10, 0, 5, 0], totalIndices: [1, 3]);
    ...
    {
        var bars = WaterfallBarPlanner.Compute([10, -4, 0], totalIndices: [2]);
    ...
    {
        var bars = WaterfallBarPlanner.Compute([0, 10], totalIndices: [0]);
