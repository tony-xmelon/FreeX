...
public sealed partial class AccessibilityCheckerServiceTests
{
    ...
    [InlineData("click to download")]
    [InlineData("click to open")]
    ...
    [InlineData("More information about Q4 revenue")]
    [InlineData("Additional details about supplier onboarding")]
    [InlineData("Find out more about Q4 revenue")]
    [InlineData("Click for more details about Q4 revenue")]
    [InlineData("Open document for board packet")]
