...
/// <summary>
/// r249: a coverage contract that uses the type's OWN definition of itself as the field list.
/// <para>
/// <c>ConditionalFormat.Clone</c> is the maintained enumeration of what a conditional-format rule
...
/// </para>
/// </summary>
public sealed class R249_ConditionalFormatComparisonCoverageContractTests
{
    [Fact]
    public void SameAsComparesEveryMemberCloneCopies()
    {
        var source = File.ReadAllText(Path.Combine(
            ...
            "ConditionalFormat.cs"));

        var cloneBody = MemberBody(source, source.IndexOf("public ConditionalFormat Clone(", StringComparison.Ordinal));
        ...
        cloned.Should().HaveCountGreaterThan(40,
