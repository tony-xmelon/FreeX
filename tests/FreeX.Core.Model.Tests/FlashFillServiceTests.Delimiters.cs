...
public sealed partial class FlashFillServiceTests
{
    ...
    [Fact]
    public void Fill_ExtractMiddleDottedToken_ExtractsInteriorTokenFromThreeTokenSources()
    {
        var result = FlashFillService.Fill(
            [
                ("Region.East.001", "East"),
                ("Team.Alpha.Q1", "Alpha")
            ],
            ["Area.South.003"]);

        result.Should().BeEquivalentTo(["South"], o => o.WithStrictOrdering());
    }

    [Fact]
    public void Fill_ExtractMiddleDottedToken_TrimsWhitespaceAroundSourceAndToken()
    {
        var result = FlashFillService.Fill(
            [
                (" Region . East . 001 ", "East"),
    ...
    public void Fill_ExtractMiddleDottedToken_ReturnsNullWhenRemainingIsNotExactlyThreeNonEmptyTokens(string remaining)
    {
        var result = FlashFillService.Fill(
            [
                ("Region.East.001", "East"),
    ...
    [Fact]
    public void Fill_ExtractMiddleDottedToken_DoesNotOverrideFinalDottedTokenExtraction()
    {
        var result = FlashFillService.Fill(
            [
                ("Region.East.001", "001"),
        ...
        result.Should().BeEquivalentTo(["003"], o => o.WithStrictOrdering());
    }

    [Fact]
    public void Fill_ExtractMiddleDottedToken_DoesNotOverrideFinalDottedTokenRemoval()
    {
        var result = FlashFillService.Fill(
            [
                ("Region.East.001", "Region.East"),
                ("Team.Alpha.Q1", "Team.Alpha")
            ],
            ["Area.South.003"]);

        result.Should().BeEquivalentTo(["Area.South"], o => o.WithStrictOrdering());
    }

    [Fact]
    public void Fill_ExtractFirstDottedToken_ExtractsFirstTokenFromThreeTokenSources()
    {
        var result = FlashFillService.Fill(
            [
                ("Region.East.001", "Region"),
                ("Team.Alpha.Q1", "Team")
            ],
            ["Area.South.003"]);

        result.Should().BeEquivalentTo(["Area"], o => o.WithStrictOrdering());
    }

    [Fact]
    public void Fill_ExtractFirstDottedToken_TrimsWhitespaceAroundSourceAndToken()
    {
        var result = FlashFillService.Fill(
            [
                (" Region . East . 001 ", "Region"),
    ...
    [InlineData("Area.South.")]
    [InlineData("Area.South.003.Extra")]
    public void Fill_ExtractFirstDottedToken_ReturnsNullWhenRemainingIsNotExactlyThreeNonEmptyTokens(string remaining)
    {
        var result = FlashFillService.Fill(
            [
                ("Region.East.001", "Region"),
    ...
    [Fact]
    public void Fill_ExtractFirstDottedToken_DoesNotOverrideFinalDottedTokenExtraction()
    {
        var result = FlashFillService.Fill(
            [
                ("Region.East.001", "001"),
    ...
    [Fact]
    public void Fill_ExtractFirstDottedToken_DoesNotOverrideFinalDottedTokenRemoval()
    {
        var result = FlashFillService.Fill(
            [
                ("Region.East.001", "Region.East"),
    ...
    [Fact]
    public void Fill_ExtractFirstDottedToken_DoesNotOverrideLeadingDottedTokenRemoval()
    {
        var result = FlashFillService.Fill(
            [
                ("Region.East.001", "East.001"),
                ("Team.Alpha.Q1", "Alpha.Q1")
            ],
            ["Area.South.003"]);
