...
public sealed class RibbonCommandPresentationPlannerTests
{
    ...
    [InlineData("3D Line Chart", true)]
    [InlineData("3D Pie Chart", true)]
    [InlineData("3D Bar Chart", true)]
    [InlineData("3D Area Chart", true)]
    [InlineData("Surface Chart", true)]
    [InlineData("3D Surface Chart", true)]
    [InlineData("Treemap Chart", true)]
    [InlineData("Sunburst Chart", true)]
    [InlineData("Histogram Chart", true)]
    [InlineData("Pareto Chart", true)]
    [InlineData("Box and Whisker Chart", true)]
    [InlineData("Waterfall Chart", true)]
    [InlineData("Funnel Chart", true)]
