...
public static class SmartArtAuthoringPlanner
{
    ...
    public const string GroupedListLayoutCommandId = "freep.smartart.layout.grouped-list";
        ...
        SmartArtLayoutPreset preset)
    {
        ...
        var (layoutId, family) = preset switch
        {
            ...
            SmartArtLayoutPreset.VerticalBlockList =>
                ("urn:microsoft.com/office/officeart/2005/8/layout/verticalBlockList", SmartArtFamily.List),
            ...
            SmartArtLayoutPreset.GroupedList =>
                ("urn:microsoft.com/office/officeart/2005/8/layout/groupedList", SmartArtFamily.List),
