...
internal static class SmartArtInsertionFactory
{
        ...
        IReadOnlyList<SlideObjectPicturePayload>? pictures = null)
    {
        ...
        AddPart(smart, "application/vnd.openxmlformats-officedocument.drawingml.diagramLayout+xml", layoutPath,
            SmartArtNativePartFactory.CreateLayoutDefinition(smart.Data.LayoutUniqueId));
    ...
    {
        if (preset is not (SmartArtLayoutPreset.PictureAccentProcess or SmartArtLayoutPreset.PictureCaptionList or SmartArtLayoutPreset.PictureAccentList or SmartArtLayoutPreset.PictureStack or SmartArtLayoutPreset.PictureLineup or SmartArtLayoutPreset.PictureStrips or SmartArtLayoutPreset.ContinuousPictureList or SmartArtLayoutPreset.PictureGrid or SmartArtLayoutPreset.VerticalPictureList))
            return null;
    ...
    private static (string layoutId, SmartArtFamily family) GetLayoutDefinition(SmartArtLayoutPreset preset) =>
        preset switch
        {
            ...
            SmartArtLayoutPreset.IncreasingCircleProcess => ("urn:microsoft.com/office/officeart/2005/8/layout/increasingCircleProcess", SmartArtFamily.Process),
            ...
            SmartArtLayoutPreset.GroupedList => ("urn:microsoft.com/office/officeart/2005/8/layout/groupedList", SmartArtFamily.List),
            ...
            SmartArtLayoutPreset.List2 => ("urn:microsoft.com/office/officeart/2005/8/layout/list2", SmartArtFamily.List),
