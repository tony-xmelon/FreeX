...
public static class FreePRibbon
{
    ...
    private static void AddInsertGroups(RibbonTabBuilder tab)
    {
        ...
        tab.Group("charts", FreePRibbonText.ChartsGroupLabel, FreePRibbonText.ChartsGroupKeyTip, 93, group =>
        {
            ...
            group.Medium(ChartExSeriesLayoutPlanner.CommandId, FreePRibbonText.ChartExSeriesLayoutLabel, RibbonCommandIconKind.ChartTitle, FreePRibbonText.ChartExSeriesLayoutKeyTip);
        ...
        tab.Group("links", FreePRibbonText.LinksGroupLabel, FreePRibbonText.LinksGroupKeyTip, 92, group =>
        {
            ...
            group.Medium(ZoomCoverImagePlanner.CommandId, FreePRibbonText.SetZoomCoverImageLabel,
                RibbonCommandIconKind.Picture, FreePRibbonText.SetZoomCoverImageKeyTip);
            group.Medium(ZoomCoverImagePlanner.ResetCommandId, FreePRibbonText.ResetZoomCoverImageLabel,
    ...
    {
        tab.Group("themes", FreePRibbonText.ThemesGroup.Label, FreePRibbonText.ThemesGroup.KeyTip, 90, group =>
        {
            // Native theme thumbnails are substantially wider than the semantic buttons they replace.
            // Reserve their real full/compact footprints so both renderers select the compact preview
            // surface before collapsing the adjacent Customize commands.
    ...
    private static void AddSmartArtGroups(RibbonTabBuilder tab)
    {
        ...
        tab.Group("smartart-layouts", FreePRibbonText.SmartArtLayoutsGroup.Label, FreePRibbonText.SmartArtLayoutsGroup.KeyTip, 80, group =>
        {
            ...
            group.Medium(SmartArtAuthoringPlanner.IncreasingCircleProcessLayoutCommandId,
                FreePRibbonText.SmartArtIncreasingCircleProcessCommand.Label, RibbonCommandIconKind.Refresh,
                FreePRibbonText.SmartArtIncreasingCircleProcessCommand.KeyTip);
            ...
            group.Medium(SmartArtAuthoringPlanner.PictureAccentProcessLayoutCommandId,
                FreePRibbonText.SmartArtPictureAccentProcessCommand.Label, RibbonCommandIconKind.Picture,
                FreePRibbonText.SmartArtPictureAccentProcessCommand.KeyTip);
    ...
    private static void AddAnimationGroups(RibbonTabBuilder tab, FreePRibbonProfile profile)
    {
        ...
        {
            // Keep the familiar effects directly reachable at narrow widths. Hosts replace the
            // authored catalog with a compact preview strip when this group enters SmallWithLabels.
            group.Sizing(RibbonGroupSizing.OfficeIconAdaptive);
            ...
            group.Medium("freep.anim.emphasis.flash-bulb", FreePRibbonText.AnimationEmphasisFlashBulbCommand.Label, RibbonCommandIconKind.Flash, FreePRibbonText.AnimationEmphasisFlashBulbCommand.KeyTip);
            group.Medium("freep.anim.emphasis.flicker", FreePRibbonText.AnimationEmphasisFlickerCommand.Label, RibbonCommandIconKind.Flash, FreePRibbonText.AnimationEmphasisFlickerCommand.KeyTip);
            ...
            group.Medium("freep.anim.emphasis.color-wave", FreePRibbonText.AnimationEmphasisColorWaveCommand.Label, RibbonCommandIconKind.Color, FreePRibbonText.AnimationEmphasisColorWaveCommand.KeyTip);
            ...
            group.Medium("freep.anim.emphasis.change-font-size", FreePRibbonText.AnimationEmphasisChangeFontSizeCommand.Label, RibbonCommandIconKind.Size, FreePRibbonText.AnimationEmphasisChangeFontSizeCommand.KeyTip);
            group.Medium("freep.anim.emphasis.change-line-color", FreePRibbonText.AnimationEmphasisChangeLineColorCommand.Label, RibbonCommandIconKind.Color, FreePRibbonText.AnimationEmphasisChangeLineColorCommand.KeyTip);
            group.Medium("freep.anim.emphasis.change-font-style", FreePRibbonText.AnimationEmphasisChangeFontStyleCommand.Label, RibbonCommandIconKind.Bold, FreePRibbonText.AnimationEmphasisChangeFontStyleCommand.KeyTip);
