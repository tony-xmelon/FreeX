...
public static class SlideCloner
{
    ...
    private static ChartShape CloneChart(ChartShape src)
    {
        var copy = new ChartShape
        {
            ...
            ChartExTitlePosition = src.ChartExTitlePosition,
            ChartExTitleAlignment = src.ChartExTitleAlignment,
            ...
            ChartExTitleEditRequested = src.ChartExTitleEditRequested,
            ChartExChartAreaEditRequested = src.ChartExChartAreaEditRequested,
            ...
            ChartExLegendEditRequested = src.ChartExLegendEditRequested,
            ChartExPlotAreaEditRequested = src.ChartExPlotAreaEditRequested,
