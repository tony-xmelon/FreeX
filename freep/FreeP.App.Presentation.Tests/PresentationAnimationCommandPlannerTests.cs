...
public sealed class PresentationAnimationCommandPlannerTests
{
    ...
    [InlineData("freep.anim.entrance.dissolve", AnimationKind.Entrance, AnimationPreset.Dissolve)]
    [InlineData("freep.anim.entrance.flash", AnimationKind.Entrance, AnimationPreset.Flash)]
    [InlineData("freep.anim.entrance.crawl", AnimationKind.Entrance, AnimationPreset.Crawl)]
    [InlineData("freep.anim.entrance.peek", AnimationKind.Entrance, AnimationPreset.Peek)]
    [InlineData("freep.anim.entrance.spiral", AnimationKind.Entrance, AnimationPreset.Spiral)]
    [InlineData("freep.anim.entrance.swivel", AnimationKind.Entrance, AnimationPreset.Swivel)]
    [InlineData("freep.anim.entrance.bounce", AnimationKind.Entrance, AnimationPreset.Bounce)]
    [InlineData("freep.anim.entrance.float", AnimationKind.Entrance, AnimationPreset.Float)]
    [InlineData("freep.anim.entrance.swoop", AnimationKind.Entrance, AnimationPreset.Swoop)]
    [InlineData("freep.anim.entrance.boomerang", AnimationKind.Entrance, AnimationPreset.Boomerang)]
    ...
    [InlineData("freep.anim.exit.dissolve-out", AnimationKind.Exit, AnimationPreset.Dissolve)]
    [InlineData("freep.anim.exit.flash-out", AnimationKind.Exit, AnimationPreset.Flash)]
    [InlineData("freep.anim.exit.crawl-out", AnimationKind.Exit, AnimationPreset.Crawl)]
    [InlineData("freep.anim.exit.peek-out", AnimationKind.Exit, AnimationPreset.Peek)]
    [InlineData("freep.anim.exit.spiral-out", AnimationKind.Exit, AnimationPreset.Spiral)]
    [InlineData("freep.anim.exit.swivel-out", AnimationKind.Exit, AnimationPreset.Swivel)]
    [InlineData("freep.anim.exit.bounce-out", AnimationKind.Exit, AnimationPreset.Bounce)]
    [InlineData("freep.anim.exit.float-out", AnimationKind.Exit, AnimationPreset.Float)]
    [InlineData("freep.anim.exit.swoop-out", AnimationKind.Exit, AnimationPreset.Swoop)]
    [InlineData("freep.anim.exit.boomerang-out", AnimationKind.Exit, AnimationPreset.Boomerang)]
