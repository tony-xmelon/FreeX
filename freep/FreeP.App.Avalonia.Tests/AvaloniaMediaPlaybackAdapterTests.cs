...
public sealed class AvaloniaMediaPlaybackAdapterTests
{
    ...
    public void Controller_ClampsVolumeToSharedZeroToHundredRange()
    {
        ...
        controller.TrySetVolume(42, 150).Should().BeTrue();
        mediaSession.Volume.Should().Be(100);
        controller.TrySetVolume(42, -25).Should().BeTrue();
        mediaSession.Volume.Should().Be(0);
        controller.Teardown();
    }
    ...
    public void Controller_RefreshesCaptionOverlayFromPlaybackPosition()
    {
        ...
        captionRun.Foreground.Should().BeOfType<global::Avalonia.Media.SolidColorBrush>()
            .Which.Color.Should().Be(global::Avalonia.Media.Color.FromArgb(0x80, 0xFF, 0xCC, 0x00));
        captionRun.Background.Should().BeOfType<global::Avalonia.Media.SolidColorBrush>()
            .Which.Color.Should().Be(global::Avalonia.Media.Color.FromArgb(0x80, 0x00, 0x00, 0x00));
