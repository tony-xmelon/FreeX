...
/// <c>Window creation</c> is indistinguishable from "this machine has no
/// drawing backend". Either way the answer is "unavailable", and every
/// <c>if (!ran) return;</c> in this assembly -- every one of them -- returns before
...
public sealed class R360_HeadlessBackendIsAvailableTests
{
    ...
    public void TheHeadlessBackendProbeSucceeded()
    {
        ...
        failure.Should().BeNull(
            ...
            "Otherwise the probe caught a real regression in window creation: " +
