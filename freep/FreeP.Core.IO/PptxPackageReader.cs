...
public static class PptxPackageReader
{
    ...
    private static bool IsLiveSmartArtLayoutSupported(string uniqueId, SmartArtFamily family)
    {
        ...
        return family switch
        {
            ...
            SmartArtFamily.List => layoutId is "list1" or "list2" or "basicblocklist" or "verticalboxlist" or "verticalchevronlist" or "stackedlist" or "descendingblocklist" or "basicpyramid" or "pyramidlist" or "invertedpyramid" or "horizontalbulletlist" or "horizontalblocklist" or "picturecaptionlist" or "pictureaccentlist" or "picturestack" or "picturelineup" or "continuouspicturelist" or "picturegrid",
