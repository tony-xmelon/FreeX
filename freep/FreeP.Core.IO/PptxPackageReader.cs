...
public static class PptxPackageReader
{
    ...
    private static bool IsPictureNodeLayout(string uniqueId)
    {
        ...
        return id.Split('/').Last() is "picturecaptionlist" or "pictureaccentlist" or "picturestack" or "picturelineup" or "picturestrips" or "horizontalpicturelist" or "continuouspicturelist" or "picturegrid" or "verticalpicturelist";
    }
    ...
    private static SmartArtFamily ClassifySmartArtFamily(string uniqueId)
    {
        ...
        if (uid.Contains("list") || uid.Contains("lproc") || uid.Contains("bullet")
            || uid.Contains("pyramid") || uid.Contains("stack") || uid.Contains("picturegrid") || uid.Contains("pictureaccentlist") || uid.Contains("picturestack") || uid.Contains("picturelineup") || uid.Contains("picturestrips") || uid.Contains("horizontalpicturelist") || uid.Contains("continuouspicturelist") || uid.Contains("verticalpicturelist"))
            return SmartArtFamily.List;
    ...
    private static bool IsLiveSmartArtLayoutSupported(string uniqueId, SmartArtFamily family)
    {
        ...
        return family switch
        {
            ...
            SmartArtFamily.List => layoutId is "list1" or "list2" or "basicblocklist" or "verticalboxlist" or "verticalchevronlist" or "verticalarrowlist" or "stackedlist" or "descendingblocklist" or "basicpyramid" or "pyramidlist" or "invertedpyramid" or "horizontalbulletlist" or "horizontalblocklist" or "trapezoidlist" or "picturecaptionlist" or "pictureaccentlist" or "picturestack" or "picturelineup" or "picturestrips" or "horizontalpicturelist" or "continuouspicturelist" or "picturegrid" or "verticalpicturelist",
            SmartArtFamily.Cycle => layoutId is "cycle1" or "radial1" or "basiccycle" or "multidirectionalcycle" or "segmentedcycle" or "radialcycle" or "radialcluster" or "radiallist" or "gearcycle" or "textcycle" or "blockcycle" or "nondirectionalcycle" or "continuouscycle",
