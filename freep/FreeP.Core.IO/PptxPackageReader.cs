...
public static class PptxPackageReader
{
    ...
    private static bool IsLiveSmartArtLayoutSupported(string uniqueId, SmartArtFamily family)
    {
        ...
        return family switch
        {
            ...
            SmartArtFamily.Cycle => layoutId is "cycle1" or "basiccycle" or "radialcycle" or "gearcycle" or "textcycle" or "blockcycle" or "nondirectionalcycle" or "continuouscycle",
