...
public static class PptxPackageReader
{
    ...
    private static bool IsPictureNodeLayout(string uniqueId)
    {
        ...
        return id.Split('/').Last() is "picturecaptionlist" or "pictureaccentlist" or "picturestack" or "picturegrid";
    }
    ...
    private static SmartArtFamily ClassifySmartArtFamily(string uniqueId)
    {
        ...
        if (uid.Contains("list") || uid.Contains("lproc") || uid.Contains("bullet")
            || uid.Contains("pyramid") || uid.Contains("stack") || uid.Contains("picturegrid") || uid.Contains("pictureaccentlist") || uid.Contains("picturestack"))
    ...
    private static bool IsLiveSmartArtLayoutSupported(string uniqueId, SmartArtFamily family)
    {
        ...
        return family switch
        {
            ...
            SmartArtFamily.List => layoutId is "list1" or "basicblocklist" or "verticalboxlist" or "stackedlist" or "descendingblocklist" or "basicpyramid" or "pyramidlist" or "picturecaptionlist" or "pictureaccentlist" or "picturestack" or "picturegrid",
