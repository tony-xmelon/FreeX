...
public class RibbonTransitionsAnimationsTests
{
    ...
    [Fact]
    public void RibbonBuild_ContainsSlideShowTab()
    {
        var def = FreeP.Ribbon.Definitions.FreePRibbon.Build(FreeP.Ribbon.Definitions.FreePRibbonCapabilities.Wpf);
        Assert.Contains(def.Tabs, t => t.Id == "slide-show");
    }
    ...
    [InlineData("freep.anim.entrance.dissolve")]
    [InlineData("freep.anim.entrance.flash")]
    [InlineData("freep.anim.entrance.crawl")]
    [InlineData("freep.anim.entrance.peek")]
    [InlineData("freep.anim.entrance.spiral")]
    [InlineData("freep.anim.entrance.swivel")]
    [InlineData("freep.anim.entrance.bounce")]
    [InlineData("freep.anim.entrance.float")]
    [InlineData("freep.anim.entrance.swoop")]
    [InlineData("freep.anim.entrance.boomerang")]
    ...
    [InlineData("freep.anim.exit.dissolve-out")]
    [InlineData("freep.anim.exit.flash-out")]
    [InlineData("freep.anim.exit.crawl-out")]
    [InlineData("freep.anim.exit.peek-out")]
    [InlineData("freep.anim.exit.spiral-out")]
    [InlineData("freep.anim.exit.swivel-out")]
    [InlineData("freep.anim.exit.bounce-out")]
    [InlineData("freep.anim.exit.float-out")]
    [InlineData("freep.anim.exit.swoop-out")]
    [InlineData("freep.anim.exit.boomerang-out")]
