...
public sealed class LocalizationKeyIntegrityTests
{
    ...
    public void AppSourceLocalizationKeys_AllExistInNeutralResources()
    {
        ...
        // Note: unlike FreeX.App.Host, FreeP.App.Host currently routes almost all UI text through
        // indirect resource-key fields (descriptor tables) rather than literal UiText.Get("...")
        // call sites, so `used` may legitimately be empty today. The sibling
